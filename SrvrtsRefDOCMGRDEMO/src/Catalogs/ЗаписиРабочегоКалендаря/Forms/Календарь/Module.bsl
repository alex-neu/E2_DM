...
Процедура ЗавершениеВыбратьКалендарьПользователя(ВыбранныеПользователи, ДопПараметры) Экспорт
	...
	Для Каждого ВыбранныйПользователь Из ВыбранныеПользователи Цикл
		ПользователиКалендаря.Добавить(ВыбранныйПользователь.Контакт);
	КонецЦикла;
	ОбновитьНастройкиОтображения();
	ЗавершениеВыбратьКалендарьПользователяСервер();
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	// Подготовим кнопки меню формы.
	Элементы.ФормаСоздатьЗаписьКалендаря.Картинка = БиблиотекаКартинок.СоздатьЭлементСписка;
	Элементы.ФормаСоздатьЗаписьКалендаря.Отображение = ОтображениеКнопки.Картинка;
	
	// Подготовим область с датой и навигацией по датам.
	...
	// Добавим выбора периода отображения.
	...
	// Для МК набор вариантов отображения отличается.
	СписокВыбора = ПериодОтображенияПолеВвода.СписокВыбора;
	СписокВыбора.Очистить();
	СписокВыбора.Добавить(Перечисления.ПериодОтображенияРабочегоКалендаря.День, "День");
	СписокВыбора.Добавить(Перечисления.ПериодОтображенияРабочегоКалендаря.ТриДня, "3 дня");
	СписокВыбора.Добавить(Перечисления.ПериодОтображенияРабочегоКалендаря.Неделя, "Неделя");
	СписокВыбора.Добавить(Перечисления.ПериодОтображенияРабочегоКалендаря.Месяц, "Месяц");
	СписокВыбора.Добавить(Перечисления.ПериодОтображенияРабочегоКалендаря.ПланДня, "План дня");
	// Переход к текущей дате сделаем картинкой.
	...
	Элементы.ФормаОтобразитьСегодня.ГоризонтальноеПоложениеВГруппе = ГоризонтальноеПоложениеЭлемента.Право;
	// Расстановка элементов по порядку.
	Элементы.Переместить(
		ПериодОтображенияПолеВвода, Элементы.ГруппаПланировщикКоманднаяПанель, Элементы.ГруппаНавигацияМК);
	Элементы.Переместить(
		Элементы.ФормаОтобразитьПредыдущийПериод, Элементы.ГруппаНавигацияМК, Элементы.НадписьПериод);
	Элементы.Переместить(
		Элементы.ФормаОтобразитьСледующийПериод, Элементы.ГруппаНавигацияМК);
	Элементы.Переместить(
		Элементы.ФормаОтобразитьСегодня, Элементы.ГруппаНавигацияМК);
	// Кнопки надо выравнивать по центру.
	Элементы.ГруппаПланировщикКоманднаяПанель.ВертикальноеПоложениеВГруппе = ВертикальноеПоложениеЭлемента.Центр;
	Элементы.ФормаОтобразитьСледующийПериод.ВертикальноеПоложениеВГруппе = ВертикальноеПоложениеЭлемента.Центр;
	Элементы.ФормаОтобразитьПредыдущийПериод.ВертикальноеПоложениеВГруппе = ВертикальноеПоложениеЭлемента.Центр;
	Элементы.ФормаОтобразитьСегодня.ВертикальноеПоложениеВГруппе = ВертикальноеПоложениеЭлемента.Центр;
	// Установим цвет картинок на кнопках.
	Элементы.ФормаОтобразитьПредыдущийПериод.ЦветТекста = ЦветаСтиля.ЦветТекстаФормы;
	Элементы.ФормаОтобразитьСледующийПериод.ЦветТекста = ЦветаСтиля.ЦветТекстаФормы;
	Элементы.ФормаОтобразитьСегодня.ЦветТекста = ЦветаСтиля.ЦветТекстаФормы;
	
	// Настроим планировщик, дату, легенду.
	...
	// Пользователя календаря переместим вниз.
	Элементы.ГруппаПользователиМК.Видимость = Истина;
	Элементы.Переместить(
		Элементы.ПользователиКалендаря, Элементы.ГруппаПользователиМК);
