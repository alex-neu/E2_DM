...
Функция ЕдиницаИзмеренияПоКоду(КодПоОКЕИ, Наименование = "", НаименованиеПолное = "") Экспорт
	...
	Иначе
		...
		Если ЕдиницаИзмерения <> Неопределено 
			И ЕдиницаИзмерения <> Справочники.КлассификаторЕдиницИзмерения.ПустаяСсылка() Тогда 
...
Функция ПравилаПересчетаЕдиницИзмерения(ТолькоИспользуемыеЕдиницы = Ложь) Экспорт
	...
	ПравилаПересчета.Колонки.Добавить("КодЕдиницыИзмерения", Новый ОписаниеТипов("Строка", , Новый КвалификаторыСтроки(3)));
	...
	ПравилаПересчета.Колонки.Добавить("КодБазовойЕдиницы",   Новый ОписаниеТипов("Строка", , Новый КвалификаторыСтроки(3)));
