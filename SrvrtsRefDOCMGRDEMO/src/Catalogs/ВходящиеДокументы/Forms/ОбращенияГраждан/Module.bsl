...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ПараметрыОткрытия = Новый Структура("Ключ, ИзСпискаОбращенийГраждан", 
		ТекущиеДанные.Ссылка, Истина);
	ОткрытьФорму("Справочник.ВходящиеДокументы.ФормаОбъекта", ПараметрыОткрытия, Элементы.Список);
...
Процедура ОтметитьКакПовторное(Команда)
	...
	ОтметитьКакПовторноеНаСервере(ДокументСсылка, Элементы.ДеревоПереписки.ТекущиеДанные.Ссылка);
	ОповеститьОбИзменении(Элементы.Список.ТекущаяСтрока);
...
Процедура ОтметитьКакДубликат(Команда)
	...
	ОтметитьКакДубликатНаСервере(ДокументСсылка, Элементы.ДеревоПереписки.ТекущиеДанные.Ссылка);
	ОповеститьОбИзменении(Элементы.Список.ТекущаяСтрока);
...
Процедура ОткрытьОтчеты(Команда)
	...
	ЗаголовокФормы = НСтр("ru = 'Отчеты по обращениям граждан'");
