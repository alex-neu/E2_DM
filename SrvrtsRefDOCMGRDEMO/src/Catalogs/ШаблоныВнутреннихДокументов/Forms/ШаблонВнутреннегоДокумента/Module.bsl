...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыРазмещения.КоманднаяПанель = Элементы.СтандартныеКоманды;
...
Процедура НоменклатураДелНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ДелопроизводствоКлиент.НоменклатураДелНачалоВыбора(
		ЭтаФорма, Элемент, СтандартнаяОбработка, Контрагенты);
...
Процедура ФайлыВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле = Элементы.ПравилоАвтозаполнения 
		...
		Если Не ЗначениеЗаполнено(Объект.ВидДокумента) Тогда 
			ПоказатьПредупреждение(, НСтр("ru = 'Не указан ""Вид документа"".'"));
		КонецЕсли;
...
Процедура ОбновитьВидимостьРеквизитов()
	...
	Если ПараметрыФункциональныхОпций.ВидВнутреннегоДокумента.ВестиУчетПоНоменклатуреДел 
		Или ПолучитьФункциональнуюОпцию("РаздельныйУчетДокументов") Тогда
		Элементы.ГруппаХранение.ОтображатьЗаголовок = Истина;
		Элементы.НоменклатураДел.Видимость = ПараметрыФункциональныхОпций.ВидВнутреннегоДокумента.ВестиУчетПоНоменклатуреДел;
	Иначе
	...
	Если ПолучитьФункциональнуюОпцию("РаздельныйУчетДокументов") 
		И Объект.ФормаДокумента = ПредопределенноеЗначение("Перечисление.ВариантыФормДокументов.Электронная") Тогда 
	...
	Если ПараметрыФункциональныхОпций.ВидВнутреннегоДокумента.УчитыватьМестоХранения <> ВариантНеУчитывать Тогда
		Элементы.МестоХранения.Видимость = ПоказыватьПоляХранения;
	Иначе
		Элементы.МестоХранения.Видимость = Ложь;
	КонецЕсли;
	
	Если ПараметрыФункциональныхОпций.ВидВнутреннегоДокумента.УчитыватьОтветственногоЗаХранение <> ВариантНеУчитывать Тогда
