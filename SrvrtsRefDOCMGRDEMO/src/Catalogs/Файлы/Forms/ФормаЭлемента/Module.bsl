...
Процедура ПроверитьЭП(Команда)
	...
	УИДПодписейКПроверке =
		ФайловыеФункцииСлужебныйКлиент.УникальныеИдентификаторыПодписей(
			ЭлектронныеПодписи,
			Элементы.ЭлектронныеПодписи.ВыделенныеСтроки);
	
	ДополнительныеПараметры = Новый Структура;
	ДополнительныеПараметры.Вставить("УИДПодписей", УИДПодписейКПроверке);
	...
	ФайловыеФункцииСлужебныйКлиент.ПроверитьПодписи(ЭтотОбъект,
		...
		Новый ОписаниеОповещения("ПроверитьЭПЗавершение", ЭтотОбъект, ДополнительныеПараметры));
...
Процедура ПроверитьВсе(Команда)
	...
	УИДПодписейКПроверке =
		ФайловыеФункцииСлужебныйКлиент.УникальныеИдентификаторыПодписей(ЭлектронныеПодписи);
	...
	ПолучитьДанныеФайлаЕслиНекорректны();
	СтруктураВозврата = РаботаСФайламиВызовСервера.ДанныеФайлаИДвоичныеДанные(Объект.Ссылка);
	ФайловыеФункцииСлужебныйКлиент.ПроверитьПодписи(
		ЭтотОбъект,
		СтруктураВозврата.ДвоичныеДанные, , ,
		Новый ОписаниеОповещения("ПроверитьЭПЗавершение", ЭтотОбъект, ДополнительныеПараметры));
...
Процедура ПроверитьЭПЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ФайловыеФункцииСлужебныйКлиент.ОбработатьПроверкуПодписей(
		ЭлектронныеПодписи,
		ДополнительныеПараметры.УИДПодписей,
		УникальныйИдентификатор);
...
Процедура СоздатьШтампПодписиСервер()
	...
	НаборЗаписей.Отбор.Объект.Установить(Объект.ТекущаяВерсия);
