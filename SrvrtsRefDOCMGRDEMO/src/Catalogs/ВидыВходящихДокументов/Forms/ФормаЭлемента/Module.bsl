...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если Объект.Ссылка.Пустая() Тогда 
		ПараметрыЗаписи.Вставить("ЗаписатьШаблон", Истина);
	КонецЕсли;
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если Не МногоШаблонов 
		...
		Или (Не ШаблонДокумента.Ссылка.Пустая() 
			И (ШаблонИзменен() Или ПараметрыЗаписи.Свойство("ИзменилосьНаименование")))) Тогда 
...
Процедура НоменклатураДелНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ДелопроизводствоКлиент.НоменклатураДелНачалоВыбора(
		ЭтаФорма, Элемент, СтандартнаяОбработка, ШаблонДокумента.Отправитель, Истина);
...
Процедура УстановитьДоступность(Форма)
	...
	УстановитьДоступностьОпции(Форма, "ОбязателенФайлОригинала",
		НЕ (Форма.РаздельныйУчетДокументов 
...
Процедура ОбновитьВидимостьРеквизитов(Форма)
	...
	Если Объект.ЯвляетсяОбращениемОтГраждан И Форма.ВестиУчетОбращенийГраждан Тогда  
		...
		Форма.Объект.ИспользоватьСрокИсполнения = Истина;
