...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОбязательныйДляШифрования.Видимость = Пользователи.ЭтоПолноправныйПользователь();
...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	ОбязательныйДляШифрованияНачальноеЗначение = Объект.ОбязательныйДляШифрования;
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ОбязательныйДляШифрованияНачальноеЗначение <> Объект.ОбязательныйДляШифрования Тогда
		ПротоколированиеРаботыПользователей.ЗаписатьСменуСвойстваСертификатаОбязательныйДляШифрования(Объект.Ссылка);
	КонецЕсли;	
...
Процедура ПриСозданииНаСервереПриЧтенииНаСервере()
	...
	Элементы.Добавил.Видимость = Объект.Добавил <> Пользователи.ТекущийПользователь();
