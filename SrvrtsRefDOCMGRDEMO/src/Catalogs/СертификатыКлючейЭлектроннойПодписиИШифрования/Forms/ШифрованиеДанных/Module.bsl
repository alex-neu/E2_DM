...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если УказанНеизменяемыйНаборСертификатов Тогда
		Элементы.СтраницаВыборСертификата.Видимость = Ложь;
...
Процедура ПриОткрытии(Отказ)
	...
	Если Не Отказ И ЗначениеЗаполнено(Сертификат) Тогда
		
		ПриИзмененииСпискаСертификатов();
...
Процедура СертификатыШифрованияПередУдалением(Элемент, Отказ)
	...
	Если Элемент.ТекущиеДанные <> Неопределено
		И Элемент.ТекущиеДанные.ОбязательныйДляШифрования = Истина Тогда
		
		ПоказатьПредупреждение(, НСтр("ru = 'Нельзя удалить обязательный для шифрования сертификат.'"));
		Отказ = Истина;
	КонецЕсли;
...
Процедура СертификатПриИзмененииНаСервере(ОтпечаткиСертификатовНаКлиенте, ПроверитьСсылку = Ложь)
	...
	ЭлектроннаяПодписьСлужебный.ДобавитьОбязательныеДляШифрованияСертификаты(ЭтотОбъект, СертификатПрограмма);
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементОтбораДанных.ЛевоеЗначение  = Новый ПолеКомпоновкиДанных("СертификатыШифрования.ОбязательныйДляШифрования");
	ЭлементОтбораДанных.ВидСравнения   = ВидСравненияКомпоновкиДанных.Равно;
	ЭлементОтбораДанных.ПравоеЗначение = Истина;
	ЭлементОтбораДанных.Использование  = Истина;
	
	ЭлементОформляемогоПоля = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	ЭлементОформляемогоПоля.Поле = Новый ПолеКомпоновкиДанных("СертификатыШифрованияСертификат");
...
#Область ОбработчикиСобытийЭлементовТаблицыСертификатСписокВыбора
...
&НаКлиенте
Процедура СертификатСписокВыбораПриАктивизацииСтрокиЗавершение(ОтпечаткиСертификатовНаКлиенте, Неопределен) Экспорт
