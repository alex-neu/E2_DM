...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.ГруппаРезультатСогласованияЦиклЛистСогласования.Группировка = ГруппировкаПодчиненныхЭлементовФормы.Вертикальная;
	Элементы.РезультатСогласования.Ширина = 0;
	...
	ЭлементыОсновное.Добавить(Элементы.ГруппаРезультатСогласованияЦиклЛистСогласования);
	ЭлементыОсновное.Добавить(Элементы.ХодИсполнения);
	...
	ПараметрыАдаптациии.ЭлементИсполнители = Элементы.ХодИсполнения;
