...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "ЗадачаВыполнена" Или ИмяСобытия = "ОтмененоВыполнениеЗадачи" Тогда
...
Процедура ЗаполнитьПоШаблону(Команда)
	...
	ШаблоныПоПредметам.ЗагрузитьЗначения(
		ШаблоныБизнесПроцессов.ШаблоныПоОбъектам(Предметы, Тип("СправочникСсылка.ШаблоныСогласования")));
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	// Вверх/вниз должны быть в контекстном меню.
	Элементы.Переместить(Элементы.ПереместитьВверх, Элементы.ИсполнителиКонтекстноеМеню);
	Элементы.Переместить(Элементы.ПереместитьВниз, Элементы.ИсполнителиКонтекстноеМеню);
	...
	Элементы.Переместить(Элементы.ВариантСогласования, Элементы.ГруппаИсполнители);
