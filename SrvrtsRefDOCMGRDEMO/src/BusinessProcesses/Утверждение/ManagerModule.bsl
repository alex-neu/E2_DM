	...
	ИначеЕсли ЗадачаОбъект.ТочкаМаршрута = ТочкиМаршрута.Ознакомиться Тогда
		...
		Если НайденнаяСтрока <> Неопределено Тогда
			Если НайденнаяСтрока.ОтправленоНаПовторноеУтверждение Тогда
				Если РеквизитыБизнесПроцесс.ВидПроцесса = Перечисления.ВидыБизнесПроцессаУтверждение.Подписание Тогда
					Представление = НСТР("ru = 'Отправлено на повторную подпись.'");
				Иначе
...
Функция ПолучитьОписаниеПроцесса() Экспорт
	...
	Возврат НСтр("ru = 'Используется для передачи исходящего или внутреннего документа на утверждение / подписание руководителю или другому сотруднику.'");
	...
	ИначеЕсли ТочкаМаршрута = ТочкиМаршрутаПроцесса.Ознакомиться Тогда
		...
		Если Выборка.Следующий() Тогда
			...
			Если Выборка.ОтправленоНаПовторноеУтверждение Тогда
				Если ВидПроцесса = Перечисления.ВидыБизнесПроцессаУтверждение.Подписание Тогда
					Действие = НСтр("ru = 'Отправлено на повторную подпись'");
				Иначе
					Действие = НСтр("ru = 'Отправлено на повторное утверждение'");
				КонецЕсли;
			Иначе
				Если ВидПроцесса = Перечисления.ВидыБизнесПроцессаУтверждение.Подписание Тогда
					Действие = НСтр("ru = 'Ознакомлен(а) с результатом подписи'");
				Иначе
