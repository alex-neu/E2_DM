...
Функция ДанныеДействия(Объект) Экспорт
	...
	ДанныеПроцесса.Описание = НСтр("ru = 'Ознакомление: '") + РеквизитыОбъекта.Наименование;
	...
	Для Каждого СтрДерева Из Дерево.Строки Цикл
		...
		Для Каждого СтрИсполнитель Из СтрДерева.Строки Цикл
			...
			Если СтрИсполнитель.Выполнена Тогда
				РезультатОзнакомления = НСтр("ru = 'Ознакомлен(а)'");
			Иначе
...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	ИначеЕсли ВидФормы = "ФормаВыбора" Тогда
		...
		СтандартнаяОбработка = Ложь;
		Параметры.Вставить("Заголовок", НСтр("ru = 'Ознакомления'"));
