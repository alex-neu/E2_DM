...
Процедура ПриЗаписи(Отказ)
	...
	Если Не ДополнительныеСвойства.Свойство("ВидЗаписи")
		Или РаботаСБизнесПроцессами.ЭтоВидЗаписиОбновленияКонтроля(ДополнительныеСвойства.ВидЗаписи) Тогда
...
Процедура ОтветственноеИсполнениеПередСозданиемЗадач(ТочкаМаршрутаБизнесПроцесса, ФормируемыеЗадачи, СтандартнаяОбработка)
	...
	Для Каждого Строка Из Исполнители Цикл
		...
		Если ЗначениеЗаполнено(Строка.НаименованиеЗадачи) Тогда
			...
			Задача.Наименование = Строка.НаименованиеЗадачи + НСтр("ru = ' (ответственный исполнитель)'");
			...
			Если ДобавлятьНаименованиеПредмета Тогда
				...
				Если НЕ ПустаяСтрока(ПредметыСтрокой) Тогда 
					Задача.Наименование = Задача.Наименование + " (" + ПредметыСтрокой + ")";
				КонецЕсли;
			КонецЕсли;
