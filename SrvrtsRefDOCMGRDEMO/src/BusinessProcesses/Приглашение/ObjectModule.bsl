				...
				Для Каждого Предмет Из ПредметыДляУстановки Цикл
					...
					Если УправлениеМероприятиями.ЭтоМероприятие(Предмет, Мероприятие) 
						...
						Если НайденныеСтроки.Количество() > 0 Тогда 
							...
							НаборЗаписей.Отбор.УдалитьИсполнитель.Установить(ЗначенияКлюча.УдалитьИсполнитель);
							НаборЗаписей.Отбор.УдалитьОсновнойОбъектАдресации.Установить(ЗначенияКлюча.УдалитьОсновнойОбъектАдресации);
							НаборЗаписей.Отбор.УдалитьДополнительныйОбъектАдресации.Установить(ЗначенияКлюча.УдалитьДополнительныйОбъектАдресации);
							...
							НаборЗаписей.ДополнительныеСвойства.Вставить("ПропуститьОбновлениеАдреснойКниги", Истина);
