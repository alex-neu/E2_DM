...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.НовыйСрокВремя.РастягиватьПоГоризонтали = Истина;
	Элементы.НовыйСрокВремя.Ширина = 0;
	...
	ПараметрыАдаптациии.ЭлементРасположениеСтраниц = Элементы.ГруппаОписаниеЗадачи;
	...
	ЭлементыОсновное.Добавить(Элементы.ГруппаИнфо);
	ЭлементыОсновное.Добавить(Элементы.ГруппаСрокиИПредметРассмотрения);
	ЭлементыОсновное.Добавить(Элементы.ГруппаДополнительныеРеквизиты);
	...
	Элементы.КомандаРассмотрено.Картинка = БиблиотекаКартинок.ЗадачаУспешноеВыполнение;
	Элементы.КомандаНеПереносить.Картинка = БиблиотекаКартинок.ЗадачаНеУспешноеВыполнение;
