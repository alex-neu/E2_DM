...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ПраваПоОбъекту.Изменение Тогда
		...
		Элементы.ЗавершитьПоручение.Доступность = Ложь;
...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.Свойство("ВыполнитьЗадачу") И ПараметрыЗаписи.ВыполнитьЗадачу Тогда
		...
		ПоручениеОбъект.ДополнительныеСвойства.Вставить("ОтправленоНаДоработку",
			ПараметрыЗаписи.ОтправленоНаДоработку);
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.Свойство("ВыполнитьЗадачуФоново")
		...
		ПараметрыФоновогоВыполнения.Вставить("ОтправленоНаДоработку",
			ПараметрыЗаписи.ОтправленоНаДоработку);
	КонецЕсли;
...
&НаКлиенте
Процедура ЗавершитьПоручение(Команда)
...
Процедура ПродолжениеВыполненияЗадачиЗавершитьПоручениеПослеВыбораФактическогоИсполнителя(
	...
	ПараметрыОповещения.Вставить("ОтправленоНаДоработку", Ложь);
...
Процедура ПродолжениеВыполненияЗадачиПослеВыбораФактическогоИсполнителя(
	...
	Если ПустаяСтрока(Объект.РезультатВыполнения) Тогда
	...
	ПараметрыОповещения = Новый Структура;
	ПараметрыОповещения.Вставить("ОтправленоНаДоработку", Истина);
...
Процедура ПродолжениеВыполненияЗадачиПослеПроверкиНаЗанятыеФайлы(Результат, Параметры) Экспорт
	...
	ПараметрыЗаписи.Вставить("ОтправленоНаДоработку", Параметры.ОтправленоНаДоработку);
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.ЗавершитьПоручение.Картинка = БиблиотекаКартинок.ЗадачаУспешноеВыполнение;
	Элементы.ВернутьНаДоработку.Картинка = БиблиотекаКартинок.ЗадачаНеУспешноеВыполнение;
