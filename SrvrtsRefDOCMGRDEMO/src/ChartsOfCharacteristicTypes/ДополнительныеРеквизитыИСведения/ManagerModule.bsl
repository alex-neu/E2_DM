...
// Возвращает структуру полей доп. реквизита
//
// Возвращаемое значение:
//   Структура
//
Функция ПолучитьСтруктуруРеквизита() Экспорт
	
	Параметры = Новый Структура;
	Параметры.Вставить("Заголовок");
	Параметры.Вставить("НаборСвойств");
	Параметры.Вставить("ЭтоДополнительноеСведение");
	Параметры.Вставить("ЗаполнятьОбязательно");
	Параметры.Вставить("МногострочноеПолеВвода");
	Параметры.Вставить("ДополнительныеЗначенияИспользуются");
	Параметры.Вставить("ВладелецДополнительныхЗначений");
	Параметры.Вставить("ДополнительныеЗначенияСВесом");
	Параметры.Вставить("ЗаголовокФормыЗначения");
	Параметры.Вставить("ЗаголовокФормыВыбораЗначения");
	Параметры.Вставить("ФорматСвойства");
...
// Создает и записывает в БД доп. реквизит
//
// Параметры:
//   СтруктураДопРеквизита - Структура - структура полей доп реквизита.
//
Функция СоздатьДопРеквизит(СтруктураДопРеквизита) Экспорт
	
	НовыйДопРеквизит = СоздатьЭлемент();
	ЗаполнитьЗначенияСвойств(НовыйДопРеквизит, СтруктураДопРеквизита);
	НовыйДопРеквизит.Наименование = СтруктураДопРеквизита.Заголовок;
	НовыйДопРеквизит.Записать();
	
	Возврат НовыйДопРеквизит.Ссылка;
