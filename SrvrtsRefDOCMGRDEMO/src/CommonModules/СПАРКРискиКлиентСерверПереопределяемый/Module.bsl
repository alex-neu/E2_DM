...
Процедура ОтобразитьИндексыСПАРК(
	...
	Если Форма.ИмяФормы = "Справочник.Контрагенты.Форма.ФормаЭлемента" Тогда
		...
		ОтобразитьИндексыСПАРККонтрагента(РезультатИндексыКонтрагента, КонтрагентОбъект, Контрагент,
			Форма, ИспользованиеРазрешено, Параметры, СтандартнаяОбработка);
		
	ИначеЕсли Форма.ИмяФормы = "Справочник.ВнутренниеДокументы.Форма.ФормаЭлемента" Тогда 
...
Процедура ОтобразитьИндексыСПАРККонтрагента(
	РезультатИндексыКонтрагента,
	КонтрагентОбъект,
	Контрагент,
	Форма,
	...
	Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаЗел.Видимость  = Ложь;
	Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаОранж.Видимость  = Ложь;
	Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаКр.Видимость  = Ложь;
	
	Если Не ИспользованиеРазрешено 
		Или Не ЗначениеЗаполнено(РезультатИндексыКонтрагента.ИНН) Тогда
			...
			Иначе
				...
				Иначе
					...
					Если (РезультатИндексыКонтрагента.СводныйИндикатор >= 1)
						...
						НомерКартинки = РезультатИндексыКонтрагента.СводныйИндикатор;
						
						МассивСтрок.Добавить(Новый Структура("Заголовок, Значение, Картинка",
					...
					Если (РезультатИндексыКонтрагента.ИндексДолжнойОсмотрительности >= 0)
						...
						ФорматированнаяСтрокаЗаголовок = Новый ФорматированнаяСтрока(
							НСтр("ru='Индекс осмотрительности:'"));
						ФорматированнаяСтрокаЗначение = Новый ФорматированнаяСтрока(
							СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
								НСтр("ru='%1 (%2)'"),
						...
						МассивСтрок.Добавить(Новый Структура("Заголовок, Значение, Картинка",
							ФорматированнаяСтрокаЗаголовок,
							ФорматированнаяСтрокаЗначение, 0));
						ИнформацияВыведена = Истина;
					КонецЕсли;
					...
					Для Каждого ТекущиеДанные Из МассивСтрок Цикл
						Если Строка2Заполнена = Ложь Тогда
							...
							Если ТекущиеДанные.Картинка = 1 Тогда 
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаЗел.Видимость  = Истина;
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаОранж.Видимость  = Ложь;
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаКр.Видимость  = Ложь;
							ИначеЕсли ТекущиеДанные.Картинка = 2 Тогда 
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаЗел.Видимость  = Ложь;
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаОранж.Видимость  = Истина;
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаКр.Видимость  = Ложь;
							ИначеЕсли ТекущиеДанные.Картинка = 3 Тогда 
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаЗел.Видимость  = Ложь;
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаОранж.Видимость  = Ложь;
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаКр.Видимость  = Истина;
							Иначе 
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаЗел.Видимость  = Ложь;
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаОранж.Видимость  = Ложь;
								Элементы.ДекорацияИндексыСПАРКРискиСтрока2КартинкаКр.Видимость  = Ложь;
