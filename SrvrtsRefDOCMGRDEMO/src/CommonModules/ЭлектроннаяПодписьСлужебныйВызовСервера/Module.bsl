...
Функция ПроверитьПодпись(АдресИсходныхДанных, АдресПодписи, ОписаниеОшибки) Экспорт
	...
	РезультатПроверки = ЭлектроннаяПодпись.ПроверитьПодпись(Неопределено, АдресИсходныхДанных, АдресПодписи, ОписаниеОшибки);
	
	Если РезультатПроверки.ПодписьВерна = Истина
		И РезультатПроверки.СертификатДействителен = Истина Тогда
		
		Возврат Истина;
		
	ИначеЕсли ЗначениеЗаполнено(РезультатПроверки.ТекстОшибкиПроверкиПодписи) Тогда
	...
	ИначеЕсли ЗначениеЗаполнено(РезультатПроверки.ТекстОшибкиПроверкиСертификата) Тогда
