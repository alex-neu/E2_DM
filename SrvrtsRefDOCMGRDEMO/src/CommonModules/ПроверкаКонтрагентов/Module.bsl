...
Функция ШаблонТаблицыДанныеКонтрагентаДляДокумента()
	...
	ДанныеКонтрагентов.Колонки.Добавить("Ссылка", Справочники.ТипВсеСсылки());
...
Процедура ЗаполнитьДанныеКонтрагентовВДокументеОсновании(Форма, ДанныеКонтрагентов)
	...
	Если Форма.РеквизитыПроверкиКонтрагентов.ЭтоДокументСКонтрагентомВШапке Тогда
		...
		ИмяРеквизитаКонтрагент = ?(Форма.РеквизитыПроверкиКонтрагентов.Свойство("ИмяРеквизитаКонтрагентВШапке"),
			Форма.РеквизитыПроверкиКонтрагентов.ИмяРеквизитаКонтрагентВШапке,
			"Контрагент");
		КонтрагентРеквизитФормы = ?(Форма.РеквизитыПроверкиКонтрагентов.Свойство("КонтрагентРеквизитФормы"),
			Форма.РеквизитыПроверкиКонтрагентов.КонтрагентРеквизитФормы,
			Ложь);
		
		ДополнитьДанныеКонтрагентовВДокументе(
			ДокументСсылка,
			ДанныеКонтрагентов,
			?(КонтрагентРеквизитФормы, Форма[ИмяРеквизитаКонтрагент], ДокументОбъект[ИмяРеквизитаКонтрагент]),
