Функция ПолучитьСвязанныйДокумент(Документ, Знач ТипСвязи, 
	...
	Если ЗначениеЗаполнено(Выборка.СвязаннаяСтрока)
		И Не ЗначениеЗаполнено(Выборка.СвязанныйДокумент) Тогда
...
Процедура УдалитьСвязь(Документ, СвязанныйДокумент, ТипСвязи,
	ДополнительныйОбъектСвязи = Неопределено) Экспорт
...
Процедура УстановитьСвязь(
	...
	Если ЗначениеЗаполнено(НачальныйСвязанныйДокумент) Тогда
		Если ЗначениеЗаполнено(СвязанныйДокумент) Тогда
			СвязиДокументов.УдалитьСвязь(Документ, НачальныйСвязанныйДокумент, ТипСвязи, ДополнительныйОбъектСвязи);
			СвязиДокументов.СоздатьСвязь(Документ, СвязанныйДокумент, ТипСвязи, Установил,
...
Функция ЭтоПодходящийТипСвязи(ДокументСсылка, СвязанныйДокумент, ТипСвязи) Экспорт 
	...
	ИначеЕсли ТипСвязи = Справочники.ТипыСвязей.ДелаетНеДействующим 
		И Не Делопроизводство.ВозможноУказаниеОтменяющегоДокумента(СвязанныйДокумент) Тогда
		Возврат Ложь;
	ИначеЕсли ТипСвязи = Справочники.ТипыСвязей.НеДействуетВСоответствии 
		И Не Делопроизводство.ВозможноУказаниеОтменяющегоДокумента(ДокументСсылка) Тогда
		Возврат Ложь;
...
Функция ПолучитьВсеСвязиДокумента(Документ, ПолучатьПомеченныеНаУдаление = Истина) Экспорт
	...
	Запрос.Текст =
		...
		|	СвязиДокументов.Установил КАК Установил,
