...
Функция СоответствиеТипов() Экспорт
	...
	ДобавитьСтроку(Таблица, "DMBank",					"Справочник.КлассификаторБанков");
	ДобавитьСтроку(Таблица, "DMBankAccount",			"Справочник.БанковскиеСчета");
	...
	ДобавитьСтроку(Таблица, "DMCaseFilesListSections",	"Справочник.РазделыНоменклатурыДел");
	ДобавитьСтроку(Таблица, "DMCaseFilesCatalog",		"Справочник.НоменклатураДел");
	ДобавитьСтроку(Таблица, "DMCaseFilesDossiers",		"Справочник.ДелаХраненияДокументов");
	...
	// Отчеты за неделю.
	ДобавитьСтроку(Таблица, "DMWeeklyReport",		"Документ.ЕженедельныйОтчет");
	...
	ДобавитьСтроку(Таблица, "DMProcessConfirmationType","Перечисление.ВидыБизнесПроцессаУтверждение");
	...
	ДобавитьСтроку(Таблица, "DMCategoriesOfCases",		"Перечисление.КатегорииДел");
...
//   ЭтоДополнительноеСведение - Булево - признак доп. сведения.
//
// Возвращаемое значение:
//   ТаблицаЗначений
//
Функция СоставДополнительныхРеквизитов(СтрДополнительныеСвойстваОбъекта, СтрНаборы, ЭтоДополнительноеСведение) Экспорт
