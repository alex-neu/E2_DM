...
Процедура ЗаписатьИзменение(ОбъектДанных, Описание = "") Экспорт
	...
	Если Не ОбъектДанных.Пустая() Тогда	
		...
		ПараметрыЗаписи = Новый Структура("ОбъектДанных, ТипСобытия, Длительность, ОписаниеСобытия, ДополнительныеСведения",
			ОбъектДанных, Перечисления.ТипыСобытийПротоколаРаботыПользователей.Изменение, 0, Описание, "");
...
Процедура ОбработкаПротоколаРаботыПользователей() Экспорт
	...
	Отказ = Ложь;
	ОбщегоНазначения.ПриНачалеВыполненияРегламентногоЗадания(Метаданные.РегламентныеЗадания.ОбработкаПротоколаРаботыПользователей, Отказ);
