...
// ТокенДоступа -Строка, возвращаемый параметр 
// ДействуетДо -Дата, возвращаемый параметр 
// АдресСервераSMTP - Строка
// OAuth_redirection_uri -Строка 
// OAuthАвторизацияКлиент -Строка  
// OAuthАвторизацияКлиентСекретныйКод -Строка 
//
...
Функция ОбновитьТокенOAuth(refresh_token, ТокенДоступа, ДействуетДо, АдресСервераSMTP,
	OAuth_redirection_uri, OAuthАвторизацияКлиент, OAuthАвторизацияКлиентСекретныйКод) Экспорт
	
	Возврат Ложь;
	
КонецФункции

// Позволяет переопределить получение токена
//
// Параметры:
//
// ТокенДоступа -Строка, возвращаемый параметр 
...
// refresh_token -Строка, токен обновления 
// АдресСервераSMTP - Строка
// СтрокаCode - Строка, код авторизации
// OAuth_redirection_uri -Строка 
// OAuthАвторизацияКлиент -Строка  
// OAuthАвторизацияКлиентСекретныйКод -Строка 
//
// Возвращает Истина, если переопределило процедуру
Функция ПолучитьТокенAuth(
			ТокенДоступа, 
			ДействуетДо, 
			refresh_token,
			АдресСервераSMTP,
