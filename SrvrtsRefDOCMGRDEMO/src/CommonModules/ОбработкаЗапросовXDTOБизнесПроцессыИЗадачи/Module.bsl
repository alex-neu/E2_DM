...
Функция УдалитьНеподдерживаемыеСсылки(Строка, ПоддерживаемыеСсылки)
	...
	ПозицияКурсора = СтрНайти(Строка, "<A href=", НаправлениеПоиска.СНачала, ПозицияКурсора);
	Пока ПозицияКурсора > 0 Цикл
		...
		ПозицияКурсора = СтрНайти(Строка, "<A href=", НаправлениеПоиска.СНачала, Мин(ПозицияКурсора + 1, СтрДлина(Строка)));
	КонецЦикла;
