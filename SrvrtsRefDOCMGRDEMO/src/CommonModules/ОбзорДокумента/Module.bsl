...
Процедура ВывестиКартинкуЭДО(Форма) Экспорт 
	...
	ИначеЕсли СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ПоставленВОчередьНаОтправку
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ОжидаетсяОтправка
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.Отправлен 
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ОбменЗавершен
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ОбменЗавершенСИсправлением
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.Аннулирован
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ОжидаетсяАннулирование Тогда
	...
	ИначеЕсли СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ОтклоненПолучателем
		...
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ОжидаетсяИсправление
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ОшибкаПередачи
		Или СостояниеЭДО = Перечисления.СостоянияВерсийЭДДО.ТребуетсяАннулировать Тогда
