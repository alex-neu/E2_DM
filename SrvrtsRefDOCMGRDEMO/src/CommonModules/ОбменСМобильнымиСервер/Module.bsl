...
Функция ПолучитьHTMLреквизита(ИмяРеквизита, ЗначениеРеквизита, Вертикально = Ложь, Картинка = Неопределено)
	...
	Если ЗначениеЗаполнено(ЗначениеРеквизита) Тогда
		Если ТипЗнч(ЗначениеРеквизита) <> Тип("Строка") Тогда
			Если ТипЗнч(ЗначениеРеквизита) = Тип("СправочникСсылка.Пользователи") Или
				ТипЗнч(ЗначениеРеквизита) = Тип("СправочникСсылка.РолиИсполнителей") Тогда
...
Функция ПолучитьПараметрыСинхронизации(Пользователь) Экспорт
	...
	ПараметрыСинхронизации.Вставить("СинхронизацияПочты",
	...
	ПараметрыСинхронизации.Вставить("СинхронизацияЗадач",
		РегистрыСведений.ОбменСМобильнымиНастройкиПользователей.ПолучитьНастройку(
			Пользователь,
			Перечисления.ОбменСМобильнымиТипыНастроекПользователей.СинхронизацияЗадач));

	ПараметрыСинхронизации.Вставить("СинхронизацияКалендаря",
		РегистрыСведений.ОбменСМобильнымиНастройкиПользователей.ПолучитьНастройку(
			Пользователь,
			Перечисления.ОбменСМобильнымиТипыНастроекПользователей.СинхронизацияКалендаря));

	ПараметрыСинхронизации.Вставить("СинхронизацияКонтроля",
		РегистрыСведений.ОбменСМобильнымиНастройкиПользователей.ПолучитьНастройку(
			Пользователь,
...
Процедура ЗаписатьПодробнуюИнформациюОСобытииОбмена(ПараметрыСинхронизации, МобильныйКлиент,
	...
	Если ТипЗнч(ПараметрыСинхронизации.ПротоколируемыеТипы) = Тип("Массив") Тогда
		
		Если ПараметрыСинхронизации.ПротоколируемыеТипы.Найти(
			МП_СлужебныйПовтИсп.ТипПоСсылке(Объект)) = Неопределено Тогда
			Возврат;
		КонецЕсли;
		
	ИначеЕсли ПараметрыСинхронизации.ПротоколируемыеТипы[ТипЗначенияОбъекта] = Неопределено Тогда
