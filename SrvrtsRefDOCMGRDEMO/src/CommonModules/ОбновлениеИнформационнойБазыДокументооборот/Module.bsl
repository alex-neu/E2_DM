...
Функция ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "*";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ОбновитьСпискиАвтоподстановокАдреснойКниги";
	//
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "*";
	...
	Обработчик.Комментарий = 
		НСтр("ru = 'Заполнение ресурсов НомерИтерации, ОсновнойПредмет, ДатаНачала в служебном регистре сведений ДанныеБизнесПроцессов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение служебных идентификаторов исполнителей в процессах исполнения.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение ресурса Номер в служебном регистре сведений ДанныеБизнесПроцессов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение ресурса СрокИсполнения в служебном регистре сведений ДанныеБизнесПроцессов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Переопределение устаревших дескрипторов доступа'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление адресной книги по контрагентам,
		|созданным загрузкой из других прикладных решений'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Удаление дескрипторов доступа для виз и резолюций. В новой версии они не используются.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение нового реквизита шаблонов процессов ""Комплексный процесс"".'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Реорганизует роли исполнителей для бизнес-процесса Приглашение'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Исправление порядка действий в шаблонах процессов обработки внутренних/входящих/исходящих документов.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Реорганизует роли исполнителей для дескрипторов доступа объектов'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Приведение дескрипторов содержимого папок к новой структуре.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление прав объектов, которые хранятся в папках, не наследующих права дочерним.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление прав объектов, которые хранятся в папках, не наследующих права дочерним (ч. 2).'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита ""Создал"" в документах.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = РедакцииКонфигурацииКлиентСервер.Комментарий_2107();
	...
	Обработчик.Комментарий = НСтр("ru = 'Удаление дескрипторов доступа для банковских счетов, контактных лиц контрагентов, номенклатуры дел.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита НомерСпособаАдресации у входящих писем.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение данных для переходящих дел хранения документов.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Реорганизация ролей с объектами адресации в завершенных процессах и задачах.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Реорганизация ролей с объектами адресации в служебных шаблонах завершенных комплексных процессов.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление сроков исполнения не активных процессов, шаблонов, протоколов мероприятий.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.6.1";
	Обработчик.Процедура = "ЛокализацияКонфигурацииПереопределяемый.ПерейтиНаВерсию_2_1_6_1";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение участников в регистре ""Участники процессов""'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение унаследованных измерений в регистре ""Участники мероприятия""'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение состояний процессов'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита Шаблон в процессах'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Очистка реквизита ИсходныйШаблон в шаблонах процессов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита ИсходныйШаблон в служебных шаблонах комплексных процессов. '");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита Подразделение в справочнике Проекты. '");	
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита Подразделение в справочнике Мероприятия.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита Организация у документов'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение табличных частей ""Стороны"" шаблонов внутренних документов'");	
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение табличных частей ""Стороны"" внутренних документов'");	
	...
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.7.9";
	Обработчик.Процедура = "ЛокализацияКонфигурацииПереопределяемый.ПерейтиНаВерсию_2_1_7_9";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение порядка сортировки этапов комплексных процессов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение порядка сортировки действий схем комплексных процессов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита Подразделение у пользователей'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение наименования сторон в документах и шаблонах документов.'");
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение грифов утверждения в документах.'");
	...
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_12_1";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.12.2";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_12_2";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.5";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_5";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.6";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_6";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.7";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПеренестиСертификатыШифрованияВРегистр";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("b27b4e3c-7736-4b93-9e24-89f633ceeaa9");
	Обработчик.Комментарий = НСтр("ru = 'Перенос сертификатов шифрования в регистр.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.8";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_8";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.9";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_9";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.10";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_10";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.10";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_11";	
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.12";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПеренестиУдалитьХранимыеФайлыВерсийВДвоичныеДанныеФайлов";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("b27b4e3c-7736-4b93-9e24-89f633c11229");
	Обработчик.Комментарий = НСтр("ru = 'Перенос данных файлов в базе в регистр ДвоичныеДанныеФайлов.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.16";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_16";	
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.17";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_17";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.18";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_18";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.20";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_20";	
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.23";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_23";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.24";
	Обработчик.Процедура = "ЛокализацияКонфигурацииПереопределяемый.ПерейтиНаВерсию_2_1_13_24";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.25";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_25";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.26";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_26";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.13.28";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_13_28";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.14.1";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_14_1";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.15.1";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_15_1";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.16.3";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_16_3";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.16.4";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_16_4";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.16.5";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_16_5";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.17.5";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_17_5";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.18.4";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_18_4";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.18.5";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_18_5";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.18.6";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_18_6";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.18.8";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_18_8";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.18.11";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_18_11";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.3";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ЗаполнитьПодразделениеУПользователейОтложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("19493366-e680-4480-83f2-2812314701eb");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита Подразделение у справочника Пользователи.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.4";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_4";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.5";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_5";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.7";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_7";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.8";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_8";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.9";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ОбновитьПервоначальныйСрокИсполненияУОбращенийГраждан";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("2c4a45cd-b480-46e9-9163-09cd76ef8bab");
	Обработчик.Комментарий = НСтр("ru = 'Обновление ""Первоначального срока исполнения"" для ""Обращений граждан"".'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.10";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПоставитьДокументыГотовыеКОтправкеПоЭДОВОчередь";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("6bd64ba3-6976-4dff-8b3b-0c1772489365");
	Обработчик.Комментарий = НСтр("ru = 'Постановка готовых к отправке документов в очередь отправки ЭДО.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.11";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_11";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.12";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_12";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.13";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_13";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.15";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "Документы.ЕженедельныйОтчет.ЗаполнитьРеквизитДлительностьРабочая";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("e303d160-b710-4b95-9815-87a6642f5bae");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение ревизита ДлительностьРабочая в отчетах по рабочему времени.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.18";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_18";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.21";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_21";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.19.22";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_19_22";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.21.4";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_21_4";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.21.4";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "РегистрыСведений.СотрудникиДляКонтроляСамочувствия.ЗаполнитьВсехСотрудников";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("e303d680-b710-4b95-9815-87a6642f4bae");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение всех сотрудников для контроля самочувствия.'",
		ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.21.5";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_21_5";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.21.6";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_21_6";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.21.7";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_21_7";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.21.8";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_21_8_ОбработатьНеОтображаемыеОбсуждения";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.21.10";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_21_10";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.21.11";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ЗаполнитьФормуДокументовОтложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("e302d680-b510-4b95-9812-87a6642f4bae");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение ""Форм документов"" в документах и номенклатуре дел.'",
		ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.22.1";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_22_1";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.22.3";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_22_3";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.22.4";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ЗаполнитьПризнакНаличияОригиналовОтложенно";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("b45b05dc-91bc-4d49-b421-da0a8bd7d279");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение признака ""Оригинал получен"" в документах.'",
		ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.22.5";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_22_5";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.22.6";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_22_6";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.23.2";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_23_2";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.23.3";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_23_3";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.23.4";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ЗаполнитьРСЗадачиСПодзадачами";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("b34b05dc-93bc-4d49-b421-da0a8bd7d279");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение РС ЗадачиСПодзадачами.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.23.5";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_23_5";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.23.6";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_23_6";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.23.7";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_23_7";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.23.8";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_23_8";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.23.10";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_23_10";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.25.2";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_25_2";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.25.4";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_25_4";
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.25.5";
	Обработчик.РежимВыполнения = "Отложенно";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ЗаполнениеГлавныхЗадачВПроцессахРешенияВопросовВыполненияЗадач";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("180606cf-f384-45d1-9249-9af044a40953");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение главной задачи в процессах решения вопросов выполнения задач.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "2.1.26.1";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_26_1";
...
Процедура ПриДобавленииОбработчиковПереходаСДругойПрограммы(Обработчики) Экспорт
	...
	Если СтрНачинаетсяС(ПредыдущееИмяКонфигурации, "ДокументооборотКОРП")
		Или СтрНачинаетсяС(ПредыдущееИмяКонфигурации, "ДокументооборотГос") Тогда
...
Процедура ПервыйЗапуск() Экспорт
	...
	СвязиДокументов.СоздатьНастройкуСвязи(Справочники.ТипыСвязей.ПереадресованДокументомПоВопросу, 
		Справочники.ВидыВходящихДокументов.ПустаяСсылка(),
		Справочники.ВидыИсходящихДокументов.ПустаяСсылка(), 
		Перечисления.ХарактерСвязей.Множественная, 
		Справочники.ТипыСвязей.ПереадресацияДокументаПоВопросу, 
		Перечисления.ХарактерСвязей.Множественная, 
		Истина);
	...
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.НазначениеОтветственного, НСтр("ru='Назначение ответственным за документ'"));
	...
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.СозданиеКонтрагента, НСтр("ru='Создание контрагента'"));
	...
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.СозданиеОтсутствия, НСтр("ru='Создание отсутствия'"));
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.ИзменениеОтсутствия, НСтр("ru='Изменение отсутствия'"));
	
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.СозданиеБрони, НСтр("ru='Создание брони'"));
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.ИзменениеБрони, НСтр("ru='Изменение брони'"));
	
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.ИзменениеЗначенияПоказателяПроцесса, НСтр("ru='Изменение значения показателя процесса'"));
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.ИзменениеСостоянияДокументаПоЭДО, НСтр("ru='Изменение состояния документа по ЭДО'"));
...
Процедура ПервыйЗапуск_СПРОФНаКОРП() Экспорт
	...
	// ИнтернетПоддержкаПользователей.СПАРКРиски
	СПАРКРиски.ОбщиеДанныеНачальноеЗаполнениеДанныхСПАРКРиски();
	СПАРКРиски.НачальноеЗаполнениеДанныхСПАРКРиски();
	// ИнтернетПоддержкаПользователей.СПАРКРиски
	
	ЗаполнитьСвойстваПредопределенныхМетрик();
	
	ШаблоныБизнесПроцессов.ОбновитьДоступностьШаблоновПоУмолчанию();
	НастроитьЧатБота();
...
Процедура ПерейтиНаВерсию_1_3_1_2_СПРОФНаКОРП() Экспорт
	...
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ДобавлениеИзменениеНапоминаний", 
		"c999acb1-d5f5-11de-a544-00179ab398dc");
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Истина);
...
Процедура ПерейтиНаВерсию_2_0_1_1() Экспорт
	...
	Пока ВыборкаНастройки.Следующий() Цикл
		...
		КонецЕсли;
		Запрос.УстановитьПараметр("КлассИсточникаБизнесСобытия", ВыборкаНастройки.КомуНазначен);
	...
	Если Не Результат.Пустой() Тогда 
		НайденнаяПапка = Справочники.ПапкиПроектов.НайтиПоНаименованию(
			НСтр("ru = 'Общие проекты'"), Истина, Справочники.ПапкиПроектов.ПустаяСсылка());
			
		Если Не ЗначениеЗаполнено(НайденнаяПапка) Тогда 
			ПапкаОбщиеПроектыОбъект = Справочники.ПапкиПроектов.СоздатьЭлемент();
			ПапкаОбщиеПроектыОбъект.Наименование = НСтр("ru = 'Общие проекты'");
...
Процедура ПерейтиНаВерсию_2_0_1_5() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			СвойстваПользователяИБ = Пользователи.СвойстваПользователяИБ(Выборка.Автор.ИдентификаторПользователяИБ);
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Заполнение шаблоны текстов %1'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ПерейтиНаВерсию_2_0_1_21() Экспорт
	...
	// Заполнение регистра КоличествоНастроекШаблоновПроцессов
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	НастройкаШаблоновБизнесПроцессов.ШаблонБизнесПроцесса КАК ШаблонБизнесПроцесса,
		|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ НастройкаШаблоновБизнесПроцессов.КомуНазначен) КАК КоличествоНастроек
		|ИЗ
		|	РегистрСведений.НастройкаШаблоновБизнесПроцессов КАК НастройкаШаблоновБизнесПроцессов
		|
		|СГРУППИРОВАТЬ ПО
	...
	НаборЗаписей = РегистрыСведений.КоличествоНастроекШаблоновПроцессов.СоздатьНаборЗаписей();	
	...
	Пока Выборка.Следующий() Цикл
		...
		Запись.КоличествоНастроек = Выборка.КоличествоНастроек;
...
Процедура ПерейтиНаВерсию_2_0_5_2() Экспорт
	...
	Если СтарыйНаборСсылка <> Неопределено Тогда 
		...
		Попытка
			...
			СтарыйНаборОбъект.Наименование = НСтр("ru = '(Удалить) Доп. свойства справочника ""Мероприятия""'");
...
Процедура ПерейтиНаВерсию_2_0_8_6() Экспорт
	...
	// Профиль Работа с входящими и исходящими документами
	Профиль = Справочники.ПрофилиГруппДоступа.ПоставляемыйПрофильПоИдентификатору(
		"eeb325aa-db51-11de-a544-00179ab398dc");
	Если ЗначениеЗаполнено(Профиль) Тогда 
...
Процедура ПерейтиНаВерсию_2_0_9_1() Экспорт
	...
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.НазначениеОтветственного,
		НСтр("ru='Назначение ответственным за документ'"));
...
Процедура ПерейтиНаВерсию_2_0_11_1() Экспорт
	...
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Ложь);
	// В профиль Пользователи
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ЧтениеБазовойНСИДокументооборот", 
		"c999acb1-d5f5-11de-a544-00179ab398dc");
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Истина);
	...
	Пока КоличествоИтераций < Лимит Цикл
		...
		Если КоличествоИтераций % 10 = 0 Тогда
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Заполнение нового реквизита шаблонов процессов.'"),
				УровеньЖурналаРегистрации.Информация,,,
				СтрШаблон(НСтр("ru = 'Пройдено итераций: %1, обработано записей: %2'"), 
...
Процедура ПерейтиНаВерсию_2_0_17_4(Параметры) Экспорт
	...
	Запрос = Новый Запрос(
		...
		|			И ((ВЫРАЗИТЬ(ВерсииОбъектов.Комментарий КАК СТРОКА(256))) <> &СозданПоУжеИмеющемуся)
	...
	Запрос.Параметры.Вставить("СозданПоУжеИмеющемуся", НСтр("ru = 'Версия создана по уже имеющемуся объекту'"));
	Выборка = Запрос.Выполнить().Выбрать();
...
Процедура ПерейтиНаВерсию_2_1_0_2() Экспорт
	...
	СоздатьВидБизнесСобытий(Справочники.ВидыБизнесСобытий.ПолучениеВходящегоПисьма, 
		НСтр("ru='Получение входящего письма'"));
...
Процедура ЗаполнитьНомерСпособаАдресации_2_1_0_10(Параметры)  Экспорт
	...
	Пока Выборка.Следующий() Цикл	
		...
		Исключение
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ЗаполнитьНомерСпособаАдресации'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ПерейтиНаВерсию_2_1_0_11() Экспорт
	...
	ОбновляемыйОбъект.Наименование = НСтр("ru = 'Контактная информация справочника ""Контрагенты""'");
	...
	ОбновляемыйОбъект.Объект = НСтр("ru = 'Контрагенты'");
	ОбновляемыйОбъект.ПредставлениеОбъекта = НСтр("ru = 'Контрагенты'");
	ОбновлениеИнформационнойБазы.ЗаписатьДанные(ОбновляемыйОбъект);
	
	// Виды бизнес-событий.
	
	ОбновляемыйОбъект = Справочники.ВидыБизнесСобытий.СозданиеКонтрагента.ПолучитьОбъект();
	ОбновляемыйОбъект.Наименование = НСтр("ru = 'Создание контрагента'");
	ОбновлениеИнформационнойБазы.ЗаписатьДанные(ОбновляемыйОбъект);
	...
	Для Каждого Строка Из ВыборкаТаблица Цикл
		Попытка
			...
			Если ЗначениеЗаполнено(Строка.ПравилоАвтозаполнения) Тогда 
				...
				НовоеПравилоОбъект.Комментарий = НовоеПравилоОбъект.Комментарий + НСтр("ru = 'Копия правила - создана при переходе на релиз 2.1.'");
...
Процедура ПерейтиНаВерсию_2_1_0_21() Экспорт
	...
	ОбновляемыйОбъект.Наименование = НСтр("ru = 'Товары и услуги'");
	ОбновлениеИнформационнойБазы.ЗаписатьДанные(ОбновляемыйОбъект);
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Ошибка добавления поля ""Товары"" в настройки доступности по состоянию.'",
					ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
	...
	// Добавление роли в профиль Ответственные за НСИ
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Ложь);
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ДобавлениеИзменениеТоваровИУслуг", 
...
Процедура ОтказОтГруппПользователей_2_1_0_23() Экспорт
	...
	ИзменяемыйРаздел.ПредставлениеОбъекта = НСтр("ru = 'По рабочим группам'");
		...
		Для Каждого ИзменяемаяСсылка Из ИзменяемыеСсылки Цикл
			...
			Если ЗначениеЗаполнено(ИзменяемыйОбъект.Комментарий) Тогда
				ИзменяемыйОбъект.Комментарий = СтрШаблон("%1 (%2)",
					НСтр("ru = 'Помечена недействительной как дубликат одноименного подразделения'"),
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Ошибка при пометке рабочих групп недействительными'",
				ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка,,,
			ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура ПерейтиНаВерсию_2_1_2_1() Экспорт
	...
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Ложь);
	// В профиль Пользователи
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("РаботаСЗаметкамиДокументооборота", 
		"c999acb1-d5f5-11de-a544-00179ab398dc");
...
Процедура ПерейтиНаВерсию_2_1_6_7() Экспорт
	...
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Ложь);
	// В профиль Пользователи
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("РаботаСКонтрольнымиТочками", 
		"c999acb1-d5f5-11de-a544-00179ab398dc");
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Истина);
...
Процедура ПерейтиНаВерсию_2_1_7_1() Экспорт
	...
	Пока ВыборкаПоПредметам.Следующий() Цикл
		...
		Пока ВыборкаПоКоллекциям.Следующий() Цикл
			...
			НовыйСоставКоллекции = ОбщегоНазначения.СкопироватьРекурсивно(СтарыйСоставКоллекции);
...
Процедура ПерейтиНаВерсию_2_1_7_2() Экспорт
	...
	Пока ВыборкаПоКоллекциям.Следующий() Цикл
		...
		Исключение
			...
			ОтменитьТранзакцию();
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Удаление задвоенных пустых коллекций'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(Выборка.Подразделение) Тогда
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'ЗаполнитьПодразделениеВПроектах'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
					УровеньЖурналаРегистрации.Ошибка,,,
					ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура ЗаполнениеРеквизитаПодразделениеВМероприятиях_2_1_7_4(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ИмяСобытия = НСтр("ru = 'Заполнение реквизита подразделение в мероприятиях 2.1.7.4'",
				ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
...
Процедура ОбновитьДокументыОрганизациейОтложенно(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ИмяСобытия = НСтр("ru = 'Заполнение реквизита организация 2.1.7.5'",
				ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
			Комментарий = ПодробноеПредставлениеОшибки(ИнформацияОбОшибке());
			ЗаписьЖурналаРегистрации(
				ИмяСобытия,
...
Процедура ПерейтиНаВерсию_2_1_8_8() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Ошибка добавления состояний ""Подписан"" в настройки доступности по состоянию.'",
					ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
	...
	СкопироватьНастройкиДоступностиПоСостояниюДляНовогоПоля("Стороны", "Контрагент");
...
Процедура ПерейтиНаВерсию_2_1_12_1() Экспорт
	
	ЗаполнитьСвойстваПредопределенныхМетрик();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_12_2() Экспорт
	
	// Добавление видов документов в область делегирования "Документы и файлы".
	ВключитьМетаданноеВОбластьДелигирования("Справочник.ВидыВнутреннихДокументов", "65a19e5a-fd0a-4a24-93de-64cd98f60e8b");
	ВключитьМетаданноеВОбластьДелигирования("Справочник.ВидыВходящихДокументов", "65a19e5a-fd0a-4a24-93de-64cd98f60e8b");
	ВключитьМетаданноеВОбластьДелигирования("Справочник.ВидыИсходящихДокументов", "65a19e5a-fd0a-4a24-93de-64cd98f60e8b");
	
	КалендарныеГрафики.СоздатьПроизводственныйКалендарьНа2019Год(Ложь, Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_5() Экспорт
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_6() Экспорт
	
	// ИнтернетПоддержкаПользователей.СПАРКРиски
	СПАРКРиски.ОбщиеДанныеНачальноеЗаполнениеДанныхСПАРКРиски();
	СПАРКРиски.НачальноеЗаполнениеДанныхСПАРКРиски();
	
	// Добавление прав на использование СПАРКРиски
	ДокументооборотПраваДоступа.УстановитьИспользованиеПравДоступа(Ложь);
	
	// В профиль Пользователи
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ЧтениеДанныхСПАРКРиски", 
		"c999acb1-d5f5-11de-a544-00179ab398dc"); 
	
	// В профиль Ответственные за НСИ
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ЗапросНовойСправкиСПАРКРиски", 
		"7bc7f2da-db69-11de-a544-00179ab398dc"); 
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ПостановкаКонтрагентовНаМониторингСПАРКРиски",
		"7bc7f2da-db69-11de-a544-00179ab398dc");
...
Процедура ПеренестиСертификатыШифрованияВРегистр(Параметры)   Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		Запрос.Текст =
		"ВЫБРАТЬ
		|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ Файлы.Ссылка) КАК КоличествоЗаписей
		|ИЗ
		|	Справочник.Файлы.УдалитьСертификатыШифрования КАК Файлы
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СертификатыШифрования КАК СертификатыШифрования
		|		ПО (СертификатыШифрования.ЗашифрованныйОбъект = Файлы.Ссылка)
		|ГДЕ
		|	Файлы.Ссылка.Зашифрован = ИСТИНА
		|	И СертификатыШифрования.ЗашифрованныйОбъект ЕСТЬ NULL";
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			УдалитьСертификатыШифрования = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ФайлСсылка, "УдалитьСертификатыШифрования");
			УдалитьСертификатыШифрования = УдалитьСертификатыШифрования.Выгрузить();
			
			НаборЗаписей = РегистрыСведений["СертификатыШифрования"].СоздатьНаборЗаписей();
			НаборЗаписей.Отбор.ЗашифрованныйОбъект.Установить(ФайлСсылка);
			Для Каждого Подстрока Из УдалитьСертификатыШифрования Цикл
				НоваяЗапись = НаборЗаписей.Добавить();
				НоваяЗапись.УникальныйИдентификатор = Новый УникальныйИдентификатор;
				НоваяЗапись.ЗашифрованныйОбъект = ФайлСсылка;
				ЗаполнитьЗначенияСвойств(НоваяЗапись, Подстрока);
			КонецЦикла;
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ПеренестиСертификатыШифрованияВРегистр'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,
				,
				,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура ПерейтиНаВерсию_2_1_13_8() Экспорт
	
	// Добавление ролей в полномочия Пользователи.
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия(
		Метаданные.Роли.БазовыеПраваБСПКОРП, "c999acb1-d5f5-11de-a544-00179ab398dc");
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия(
		Метаданные.Роли.ЗапускМобильногоКлиента, "c999acb1-d5f5-11de-a544-00179ab398dc");
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия(
		Метаданные.Роли.РедактированиеПечатныхФорм, "c999acb1-d5f5-11de-a544-00179ab398dc");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_9() Экспорт
	
	ВыполнениеЗадачПоПочтеСервер.ВключитьИспользованиеВыполненияЗадачПоПочтеПоУмолчанию();
	ВыполнениеЗадачПоПочтеСервер.УстановитьДлинуТемыОтветногоПисьмаПоУмолчанию();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_10() Экспорт
	
	НастройкиВариантовОтчетовДокументооборот.ЗаполнитьНастройкиВариантовОтчетовДокументооборот(Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_11() Экспорт
	
	СвязиДокументов.СоздатьНастройкуСвязи(
		Справочники.ТипыСвязей.КорректировкаК,
		Справочники.ВидыВнутреннихДокументов.ПустаяСсылка(),
		Справочники.ВидыВнутреннихДокументов.ПустаяСсылка(),
		Перечисления.ХарактерСвязей.Единичная,
		Справочники.ТипыСвязей.Корректировка,
		Перечисления.ХарактерСвязей.Множественная,
		Истина);	
	...
	СвязиДокументов.СоздатьНастройкуСвязи(
		...
		Справочники.ВидыВнутреннихДокументов.ПустаяСсылка(),
		Перечисления.ХарактерСвязей.Единичная,
		Справочники.ТипыСвязей.Исправление,
		Перечисления.ХарактерСвязей.Множественная,
		Истина);	
		
КонецПроцедуры

Процедура ПеренестиУдалитьХранимыеФайлыВерсийВДвоичныеДанныеФайлов(Параметры)   Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		Запрос.Текст =
		"ВЫБРАТЬ
		|	КОЛИЧЕСТВО(ВерсииФайлов.Ссылка) КАК КоличествоЗаписей
		|ИЗ
...
Процедура ПерейтиНаВерсию_2_1_13_16() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_13_17() Экспорт
	
	Константы.АвтовизуализацияЭП.Установить(Ложь);
	Константы.РасположениеШтампаЭПВPdf.Установить(Перечисления.ВариантыПечатиШтампаЭП.ЛевыйВерхний);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_18() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_13_20() Экспорт
	
	// Добавление роли "Использование синхронизации календарей" в полномочия "Пользователи".
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия(
		Метаданные.Роли.ИспользованиеСинхронизацииКалендарей, "c999acb1-d5f5-11de-a544-00179ab398dc");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_23() Экспорт
	
	// В профиль Пользователи
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия("ФормированиеИВыгрузкаОтчетовВССТУ", 
		"eeb325ab-db51-11de-a544-00179ab398dc");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_25() Экспорт
	
	// Заполнение настройки доступности для поля "Вопросы обращения"
	НастройкаДоступностиСсылка = Справочники.НастройкиДоступностиПоСостоянию.ПолучитьСсылку(
		Новый УникальныйИдентификатор("bc60e983-8b0b-4487-9a18-1894f3b02bd4"));
	...
	НастройкаДоступностиОбъект = НастройкаДоступностиСсылка.ПолучитьОбъект();
	Если НастройкаДоступностиОбъект.НастройкиДоступности.Найти(
		"ВопросыОбращения", "ИмяПоляКоманды") <> Неопределено Тогда 
		Возврат;
	КонецЕсли;
	
	НастройкиДоступности = Делопроизводство.ПолучитьНастройкиДоступностиПоУмолчанию(
		НастройкаДоступностиОбъект.ТипДокумента, "Делопроизводитель");
	Для Каждого Строка Из НастройкиДоступности Цикл
		Если Строка.ИмяПоляКоманды = "ВопросыОбращения" Тогда 
			НоваяСтрока = НастройкаДоступностиОбъект.НастройкиДоступности.Добавить();
			ЗаполнитьЗначенияСвойств(НоваяСтрока, Строка);
		КонецЕсли;
	КонецЦикла;	
...
Процедура ПерейтиНаВерсию_2_1_13_26() Экспорт
	
	ШаблоныБизнесПроцессов.ЗаполнитьШаблоныПоУмолчанию();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_13_28() Экспорт
	
	// В настройках доступности по состоянию могли остаться группы доступа,
	// т.к. обработчик ПерейтиНаВерсию_2_1_0_25 запускался до монопольной реорганизации ролей.
	...
	Запрос = Новый Запрос(
		...
		|		ПО УчастникиНастроекДоступности.Участник = ПользователиГруппДоступа.Ссылка
		|ГДЕ
	...
	Для Каждого СтрокаНастройка Из РезультатДеревом.Строки Цикл
		...
		Для Каждого СтрокаГруппаДоступа Из СтрокаНастройка.Строки Цикл
			СтрокаСГруппойДоступа = ИзменяемыйОбъект.ИспользоватьДля.Найти(СтрокаГруппаДоступа.ГруппаДоступа, "Участник");
			СоставГруппы = СтрокаГруппаДоступа.Строки.ВыгрузитьКолонку("Пользователь");
			МассивПользователей = Новый Массив;
			Для Каждого УчастникГруппы Из СоставГруппы Цикл
				Если ТипЗнч(УчастникГруппы) = Тип("СправочникСсылка.РабочиеГруппы") Тогда
					НоваяСтрока = ИзменяемыйОбъект.ИспользоватьДля.Добавить();
					НоваяСтрока.Участник = УчастникГруппы;
				ИначеЕсли ТипЗнч(УчастникГруппы) = Тип("СправочникСсылка.Пользователи") Тогда
					МассивПользователей.Добавить(УчастникГруппы);
				КонецЕсли;
			КонецЦикла;
			// Поиски создание рабочей группы.
			Если МассивПользователей.Количество() > 0 Тогда
				...
				Если РабочаяГруппа = Неопределено Тогда
					...
					СоответствиеРабочихГруппГруппамДоступа.Вставить(СтрокаГруппаДоступа.ГруппаДоступа,
						РабочаяГруппа);
				КонецЕсли;
				СтрокаСГруппойДоступа.Участник = РабочаяГруппа;
			Иначе
				ИзменяемыйОбъект.ИспользоватьДля.Удалить(СтрокаСГруппойДоступа);
			КонецЕсли;
		КонецЦикла;
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(ИзменяемыйОбъект);
	КонецЦикла;
...
Процедура ПерейтиНаВерсию_2_1_14_1() Экспорт
...
Процедура ПерейтиНаВерсию_2_1_15_1() Экспорт
	
	КалендарныеГрафики.СоздатьПроизводственныйКалендарьНа2020Год(Ложь, Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_16_3() Экспорт
	
	Если СтандартныеПодсистемыПовтИсп.ИспользуетсяРИБ()
		И ОбщегоНазначения.ЭтоПодчиненныйУзелРИБ() Тогда
		Возврат;
	КонецЕсли;
	
	// Удаленная работа
	НаименованиеВидаОтсутствия = НСтр("ru = 'Удаленная работа'");
	Если Не ЗначениеЗаполнено(Справочники.ВидыОтсутствий.НайтиПоНаименованию(НаименованиеВидаОтсутствия, Истина)) Тогда
		ВидОтсутствияОбъект = Справочники.ВидыОтсутствий.СоздатьЭлемент();
		ВидОтсутствияОбъект.Наименование = НаименованиеВидаОтсутствия;
...
Процедура ПерейтиНаВерсию_2_1_16_4() Экспорт
	
	// Показатели виджета "Отсутствия".
	...
	ОбновлениеИнформационнойБазы.ЗаписатьДанные(Показатель);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_16_5() Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		НастройкиТекущихДелПользователя = РегистрыСведений.НастройкиТекущихДел.СоздатьМенеджерЗаписи();
		НастройкиТекущихДелПользователя.Пользователь = Выборка.Пользователь;
		НастройкиТекущихДелПользователя.Прочитать();
		Если Не НастройкиТекущихДелПользователя.Выбран() Тогда
			Продолжить;
		КонецЕсли;
		
		ВсеВиджеты = Новый Массив;
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет1_1);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет1_2);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет1_3);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет1_4);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет2_1);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет2_2);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет2_3);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет2_4);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет3_1);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет3_2);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет3_3);
		ВсеВиджеты.Добавить(НастройкиТекущихДелПользователя.Виджет3_4);
		Если ВсеВиджеты.Найти(Справочники.Виджеты.Отсутствия) <> Неопределено Тогда
			Продолжить;
		КонецЕсли;
		
		Если Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет1_1) Тогда
			НастройкиТекущихДелПользователя.Виджет1_1 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет1_2) Тогда
			НастройкиТекущихДелПользователя.Виджет1_2 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет1_3) Тогда
			НастройкиТекущихДелПользователя.Виджет1_3 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет1_4) Тогда
			НастройкиТекущихДелПользователя.Виджет1_4 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет2_1) Тогда
			НастройкиТекущихДелПользователя.Виджет2_1 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет2_2) Тогда
			НастройкиТекущихДелПользователя.Виджет2_2 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет2_3) Тогда
			НастройкиТекущихДелПользователя.Виджет2_3 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет2_4) Тогда
			НастройкиТекущихДелПользователя.Виджет2_4 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет3_1) Тогда
			НастройкиТекущихДелПользователя.Виджет3_1 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет3_2) Тогда
			НастройкиТекущихДелПользователя.Виджет3_2 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет3_3) Тогда
			НастройкиТекущихДелПользователя.Виджет3_3 = Справочники.Виджеты.Отсутствия;
		ИначеЕсли Не ЗначениеЗаполнено(НастройкиТекущихДелПользователя.Виджет3_4) Тогда
			НастройкиТекущихДелПользователя.Виджет3_4 = Справочники.Виджеты.Отсутствия;
		КонецЕсли;
		
		НастройкиТекущихДелПользователя.Записать();
		
	КонецЦикла;
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_17_5() Экспорт
	
	Константы.РасширенияФайловДляПроверкиБлокировкиФайлаНаДиске.Установить(
		"DOC DOCX XLS XLSX PPT PPTX ODT OTT ODP OTP ODS OTS ODC OTC ODF OTF ODM OTH SDW STW SXW STC SXC SDC SDD STI");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_18_4() Экспорт
	
	Если Константы.ИспользоватьЕжедневныеОтчеты.Получить() Тогда
		
		Менеджер = Константы.ПолитикаУчетаРабочегоВремени.СоздатьМенеджерЗначения();
		Менеджер.Значение = Перечисления.ПолитикиУчетаРабочегоВремени.ИспользоватьЕжедневныеОтчеты;
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(Менеджер);
		
		Менеджер = Константы.ИспользоватьДокументыУчетаРабочегоВремени.СоздатьМенеджерЗначения();
	...
	Иначе
		...
		Менеджер = Константы.ПолитикаУчетаРабочегоВремени.СоздатьМенеджерЗначения();
		Менеджер.Значение = Перечисления.ПолитикиУчетаРабочегоВремени.НеУчитывать;
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(Менеджер);
...
Процедура ПерейтиНаВерсию_2_1_18_5() Экспорт
	
	НастроитьЧатБота();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_18_6() Экспорт
	
	Константы.УведомленияОкномПоказыватьВЦентреОповещений.Установить(Истина);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_18_8() Экспорт
	
	Константы.ЛимитРазмераАвточатов.Установить(200);
...
Процедура ПерейтиНаВерсию_2_1_18_11() Экспорт
	
	// Временная удаленная работа -> Удаленная работа
	СтароеНаименованиеВидаОтсутствия = НСтр("ru = 'Временная удаленная работа'");
	НовоеНаименованиеВидаОтсутствия = НСтр("ru = 'Удаленная работа'");
	ВидОтсутствия = Справочники.ВидыОтсутствий.НайтиПоНаименованию(СтароеНаименованиеВидаОтсутствия, Истина);
	Если ЗначениеЗаполнено(ВидОтсутствия) Тогда
		ВидОтсутствияОбъект = ВидОтсутствия.ПолучитьОбъект();
		ВидОтсутствияОбъект.Наименование = НовоеНаименованиеВидаОтсутствия;
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(ВидОтсутствияОбъект);
	КонецЕсли;
	
КонецПроцедуры

Процедура ЗаполнитьПодразделениеУПользователейОтложенно(Параметры) Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		|ГДЕ
		|	Пользователи.Подразделение <> ЕСТЬNULL(СведенияОПользователяхДокументооборот.Подразделение, ЗНАЧЕНИЕ(Справочник.СтруктураПредприятия.ПустаяССылка))");
	...
	Запрос = Новый Запрос(
		...
		|	ЕСТЬNULL(СведенияОПользователяхДокументооборот.Подразделение, ЗНАЧЕНИЕ(Справочник.СтруктураПредприятия.ПустаяССылка)) КАК Подразделение
		|ИЗ
		|	Справочник.Пользователи КАК Пользователи
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СведенияОПользователяхДокументооборот КАК СведенияОПользователяхДокументооборот
		|		ПО (СведенияОПользователяхДокументооборот.Пользователь = Пользователи.Ссылка)
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			СпрОбъект.Подразделение = Выборка.Подразделение;
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось обработать пользователя %1 по причине:
					|%2'"),
				Выборка.Ссылка,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
			ЗаписьЖурналаРегистрации(
	...
	Если Обработано = 0 И ПроблемныхЗаписей > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Процедуре ЗаполнитьПодразделениеУПользователейОтложенно не удалось обработать некоторые записи (пропущены): %1'"),
			ПроблемныхЗаписей);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
	
	Параметры.ПрогрессВыполнения.ОбработаноОбъектов = 
		Параметры.ПрогрессВыполнения.ОбработаноОбъектов + Обработано;
	Параметры.ОбработкаЗавершена = Обработано = 0;
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_19_4() Экспорт
	...
	Если Не ЗначениеЗаполнено(Константы.ЯзыкРаспознавания.Получить()) Тогда
		Если ИспользоватьРаспознавание Тогда
			Константы.ЯзыкРаспознавания.Установить(
				РаботаСФайламиВызовСервера.ЯзыкРаспознаванияCuneiFormПоУмолчанию());
		Иначе
			Константы.ЯзыкРаспознавания.Установить(
				РаботаСФайламиВызовСервера.ЯзыкРаспознаванияВСервисеПоУмолчанию());
		КонецЕсли;
...
Процедура ПерейтиНаВерсию_2_1_19_5() Экспорт
	
	// заполним размеры томов
...
Процедура ПерейтиНаВерсию_2_1_19_7() Экспорт
	
	Запрос = Новый Запрос(
		"ВЫБРАТЬ
		|	ДополнительныеРеквизитыИСведения.Ссылка КАК Ссылка,
		|	ДополнительныеРеквизитыИСведения.ЗависимостиДополнительныхРеквизитов КАК Зависимости
		|ИЗ
		|	ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК ДополнительныеРеквизитыИСведения
		|");
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		ПроблемныеРеквизиты = Новый Массив;
		Зависимости = Выборка.Зависимости.Выгрузить();
		ПотенциальныеДубликаты = Зависимости.Скопировать();
		ПотенциальныеДубликаты.Колонки.Добавить("Количество");
		ПотенциальныеДубликаты.ЗаполнитьЗначения(1, "Количество");
		ПотенциальныеДубликаты.Свернуть("ЗависимоеСвойство, НаборСвойств, Реквизит, Условие", "Количество");
		Для Каждого ПотенциальныйДубликат Из ПотенциальныеДубликаты Цикл
			Если ПотенциальныйДубликат.Количество <= 1
				Или ПотенциальныйДубликат.Условие = "ВСписке"
				Или ПотенциальныйДубликат.Условие = "НеВСписке" Тогда
				Продолжить;
			КонецЕсли;
			ПроблемныеРеквизиты.Добавить(ПотенциальныйДубликат.Реквизит);
		КонецЦикла;
		ПотенциальныеДубликаты.ЗаполнитьЗначения(1, "Количество");
		ПотенциальныеДубликаты.Свернуть("ЗависимоеСвойство, НаборСвойств, Реквизит", "Количество");
		Для Каждого ПотенциальныйДубликат Из ПотенциальныеДубликаты Цикл
			Если ПотенциальныйДубликат.Количество <= 1 Тогда
				Продолжить;
			КонецЕсли;
			ПроблемныеРеквизиты.Добавить(ПотенциальныйДубликат.Реквизит);
		КонецЦикла;
		ПроблемныеРеквизиты = ОбщегоНазначенияКлиентСервер.СвернутьМассив(ПроблемныеРеквизиты);
		Для Каждого ПроблемныйРеквизит Из ПроблемныеРеквизиты Цикл
			ТекстСообщения = СтрШаблон(НСтр("ru = 'Обнаружено дублирование условий для дополнительных реквизитов и сведений.
				|Следует исправить их так, чтобы одному реквизиту (%1) соответствовало только одно условие'"),
				ПроблемныйРеквизит);
...
Процедура ПерейтиНаВерсию_2_1_19_8() Экспорт
	
	ТекущаяАкутальнаяДата = Константы.ДатаРедакцииКлассификатораОбращенийГраждан.Получить();
	...
	Константы.ДатаРедакцииКлассификатораОбращенийГраждан.Установить(ТекущаяДатаКлассификатора());
	
КонецПроцедуры

Процедура ОбновитьПервоначальныйСрокИсполненияУОбращенийГраждан(Параметры) Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		ЗапросКоличествоОбращений = Новый Запрос(
			...
			|	И Обращения.ВидДокумента.ЯвляетсяОбращениемОтГраждан
			|	И Обращения.ДатаРегистрации <> ДАТАВРЕМЯ(1, 1, 1)
			|	И Обращения.СрокИсполнения <> ДАТАВРЕМЯ(1, 1, 1)
	...
	// Заполнение реквизита "СрокИсполненияПервоначальный".
	ЗапросОбращения = Новый Запрос(
		...
		|
		|УПОРЯДОЧИТЬ ПО
		|	Обращения.ДатаРегистрации УБЫВ");
	...
	Пока ВыборкаОбращений.Следующий() Цикл
		...
		Попытка
			...
			Попытка
				...
				ЗаблокироватьДанныеДляРедактирования(ВыборкаОбращений.Ссылка);
				ОбращениеОбъект = ВыборкаОбращений.Ссылка.ПолучитьОбъект();
				ОбращениеОбъект.СрокИсполненияПервоначальный = ОбращениеОбъект.СрокИсполнения;
	...
	Если ОбработаноОбъектов = 0 И ПроблемныхОбъектов > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Процедуре ОбновитьПервоначальныйСрокИсполненияУОбращенийГраждан не удалось обработать некоторые Обращения (пропущены): %1'"),
			ПроблемныхОбъектов);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ПоставитьДокументыГотовыеКОтправкеПоЭДОВОчередь(Параметры) Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		Запрос.Текст =
			"ВЫБРАТЬ
			|	КОЛИЧЕСТВО(РАЗЛИЧНЫЕ СостояниеДокументовПоЭДО.ДокументДО) КАК КоличествоДокументов
			|ИЗ
			|	РегистрСведений.СостояниеДокументовПоЭДО.СрезПоследних КАК СостояниеДокументовПоЭДО
			|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ОчередьОтправкиДокументовЭДО КАК ОчередьОтправкиДокументовЭДО
			|		ПО СостояниеДокументовПоЭДО.ДокументДО = ОчередьОтправкиДокументовЭДО.Документ
			|ГДЕ
			|	СостояниеДокументовПоЭДО.СостояниеВерсииДокументаПоЭДО = ЗНАЧЕНИЕ(Перечисление.СостоянияВерсийЭДДО.ПоставленВОчередьНаОтправку)
			|	И СостояниеДокументовПоЭДО.НаправлениеЭД = ЗНАЧЕНИЕ(Перечисление.НаправленияЭД.Исходящий)
			|	И ОчередьОтправкиДокументовЭДО.Документ ЕСТЬ NULL
			|
			|УПОРЯДОЧИТЬ ПО
		...
		Выборка = Запрос.Выполнить().Выбрать();
		Пока Выборка.Следующий() Цикл
			ВсегоОбъектов = ВсегоОбъектов + Выборка.КоличествоДокументов;
		КонецЦикла;
	...
	Запрос.Текст =
		"ВЫБРАТЬ ПЕРВЫЕ 1000
		|	СостояниеДокументовПоЭДО.ДокументДО КАК ДокументДО
		|ИЗ
		|	РегистрСведений.СостояниеДокументовПоЭДО.СрезПоследних КАК СостояниеДокументовПоЭДО
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.ОчередьОтправкиДокументовЭДО КАК ОчередьОтправкиДокументовЭДО
		|		ПО СостояниеДокументовПоЭДО.ДокументДО = ОчередьОтправкиДокументовЭДО.Документ
		...
		|
		|СГРУППИРОВАТЬ ПО
		|	СостояниеДокументовПоЭДО.ДокументДО
		|
		|УПОРЯДОЧИТЬ ПО
		|	ДокументДО УБЫВ";
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			РегистрыСведений.ОчередьОтправкиДокументовЭДО.ПоставитьВОчередь(Выборка.ДокументДО);
		Исключение
			ЗаписьЖурналаРегистрации(
				ОбновлениеИнформационнойБазы.СобытиеЖурналаРегистрации(),
				УровеньЖурналаРегистрации.Ошибка,,,
				СтрШаблон(НСтр("ru = 'Не удалось поставить документ %1 в очередь отправки по ЭДО по причине:
						|%2'"),
					Выборка.ДокументДО,
					ПодробноеПредставлениеОшибки(ИнформацияОбОшибке())));
		КонецПопытки;
...
Процедура ПерейтиНаВерсию_2_1_19_11() Экспорт
	...
	МассивПолучателей = Запрос.Выполнить().Выгрузить().ВыгрузитьКолонку("Получатель");
	
	НаборЗаписей = РегистрыСведений.ПолучателиУведомленийОПроблемах.СоздатьНаборЗаписей();
	...
	Для Каждого Получатель Из МассивПолучателей Цикл
		...
		Если ПолучитьФункциональнуюОпцию("ИспользованиеВстроеннойПочты") Тогда
			...
			Запись.Раздел = Перечисления.РазделыУведомленийОПроблемах.Почта;
		КонецЕсли;
		
		Если ПолучитьФункциональнуюОпцию("ИспользоватьМобильныеКлиенты") Тогда
			Запись = НаборЗаписей.Добавить();
			Запись.Получатель = Получатель;
			Запись.Раздел = Перечисления.РазделыУведомленийОПроблемах.ОбменСМобильными;
		КонецЕсли;
		
		Запись = НаборЗаписей.Добавить();
		Запись.Получатель = Получатель;
		Запись.Раздел = Перечисления.РазделыУведомленийОПроблемах.Администрирование;
	КонецЦикла;
...
Процедура ПерейтиНаВерсию_2_1_19_12() Экспорт
	
	НаборЗаписей = РегистрыСведений.ОчередьОбновленияОбсуждений.СоздатьНаборЗаписей();
	
	Запрос = Новый Запрос(
		"ВЫБРАТЬ
		|	ОчередьОбновленияОбсуждений.*
		|ИЗ
	...
	Пока Выборка.Следующий() Цикл
		Запись = НаборЗаписей.Добавить();
		ЗаполнитьЗначенияСвойств(Запись, Выборка);
		Запись.ДатаВМиллиСекундах = Выборка.УдалитьДатаВМиллиСекундах;
	КонецЦикла;
...
Процедура ПерейтиНаВерсию_2_1_19_13() Экспорт
	
	// Добавление области делегирования - Административные функции
	Справочники.ОбластиДелегированияПрав.СоздатьОбластиДелегированияЕслиНужно();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_19_18() Экспорт
	
	Если Не ОбсужденияСлужебный.Подключены() Тогда
		Возврат;
	КонецЕсли;
	
	// Блокировка недействительных пользователей.
	Запрос = Новый Запрос(
		"ВЫБРАТЬ
		|	Пользователи.Ссылка КАК Ссылка
		|ИЗ
	...
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		ОбсужденияДокументооборот.ОбновитьПользователя(Выборка.Ссылка);
	КонецЦикла;
	
	// Обновление состава созданных ранее обсуждений.
	Запрос = Новый Запрос(
		"ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	Пока Выборка.Следующий() Цикл
		Если ЗначениеЗаполнено(Выборка.Родитель) Тогда
			ОбсужденияДокументооборот.ОбновитьОбсужденияПоКонтейнеру(Выборка.Родитель);
		КонецЕсли;
	КонецЦикла;
...
Процедура ПерейтиНаВерсию_2_1_19_21() Экспорт
	
	РольПросмотрПротокола = Метаданные.Роли.ПросмотрПротоколаРаботыСотрудников;
	Роль = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(РольПросмотрПротокола);
	
	Идентификатор = "a35aa932-db5a-11de-a544-00179ab398dc"; // идентификатор профиля "Руководители подразделений".
...
Процедура ПерейтиНаВерсию_2_1_19_22() Экспорт
	
	РольРаспознаваниеПоЗапросу = 
		ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Метаданные.Роли.РаспознаваниеПоЗапросу);
	...
	Если ЗначениеЗаполнено(Профиль) Тогда 
		...
		ПрофильОбъект = Профиль.ПолучитьОбъект();
		НайденнаяСтрока = ПрофильОбъект.Роли.Найти(РольРаспознаваниеПоЗапросу, "Роль");
		
		Если НайденнаяСтрока = Неопределено Тогда 
			НоваяСтрока = ПрофильОбъект.Роли.Добавить();
			НоваяСтрока.Роль = РольРаспознаваниеПоЗапросу;
			ПрофильОбъект.Записать();
		КонецЕсли;
...
Процедура ПерейтиНаВерсию_2_1_21_4() Экспорт
	
	Справочники.ГрафикУчетаСамочувствияСотрудников.ЗаполнитьГрафикПоУмолчанию();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_21_5() Экспорт
	
	Константы.МаксимальноеЧислоПринимаемыхПисем.Установить(1000);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_21_6() Экспорт
	
	Константы.ОбсужденияПодключены.Установить(
		СистемаВзаимодействия.ИнформационнаяБазаЗарегистрирована());
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_21_7() Экспорт
	
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия(
		Метаданные.Роли.ДобавлениеИзменениеКаналовОбсуждений, "c999acb1-d5f5-11de-a544-00179ab398dc");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_21_8_ОбработатьНеОтображаемыеОбсуждения(Немедленно = Ложь) Экспорт
	
	Если Немедленно <> Истина Тогда
		ДопПараметры = Новый Структура;
		ДопПараметры.Вставить("ИмяОбработчика",
			"ОбновлениеИнформационнойБазыДокументооборот.ПерейтиНаВерсию_2_1_21_8_ОбработатьНеОтображаемыеОбсуждения");
		РегистрыСведений.ОчередьОбновленияОбсуждений.Добавить(
			Перечисления.ЗаданияОчередиОбновленияОбсуждений.ВыполнитьОбработчикОбновления,, ДопПараметры);
		Возврат;
	КонецЕсли;
	...
	НомерИтерации = 0;
	ЛимитКолИтераций = 10000;
	ЕстьОбработанныеЭлементы = Истина;
	НайденныеОбсуждения = СистемаВзаимодействия.ПолучитьОбсуждения(Отбор);
	
	Пока НайденныеОбсуждения.Количество() > 0
			И ЕстьОбработанныеЭлементы
			И НомерИтерации < ЛимитКолИтераций Цикл
		
		НомерИтерации = НомерИтерации + 1;
		ЕстьОбработанныеЭлементы = Ложь;
		Для Каждого Обсуждение Из НайденныеОбсуждения Цикл
			Если СтрНайти(Обсуждение.Ключ, "Auto") > 0 Тогда
...
Процедура ПерейтиНаВерсию_2_1_21_10() Экспорт
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	ВидыДокументов.ФормаДокумента = ЗНАЧЕНИЕ(Перечисление.ВариантыФормДокументов.ПустаяСсылка)
		...
		|	ИСТИНА
		|ИЗ
		|	Справочник.ВидыВходящихДокументов КАК ВидыДокументов
		|ГДЕ
		|	ВидыДокументов.ФормаДокумента = ЗНАЧЕНИЕ(Перечисление.ВариантыФормДокументов.ПустаяСсылка)
		|	И НЕ ВидыДокументов.ЭтоГруппа
		|
		...
		|	ИСТИНА
		|ИЗ
		|	Справочник.ВидыИсходящихДокументов КАК ВидыДокументов
		|ГДЕ
		|	ВидыДокументов.ФормаДокумента = ЗНАЧЕНИЕ(Перечисление.ВариантыФормДокументов.ПустаяСсылка)
		|	И НЕ ВидыДокументов.ЭтоГруппа
		|
		...
		|ГДЕ
		|	ШаблоныДокументов.ФормаДокумента = ЗНАЧЕНИЕ(Перечисление.ВариантыФормДокументов.ПустаяСсылка)
	...
	Пока Выборка.Следующий() Цикл 
		ВидДокументаОбъект = Выборка.Ссылка.ПолучитьОбъект();
		Если Выборка.ЭтоВид = Истина Тогда 
			ВидДокументаОбъект.ФормаДокумента = Перечисления.ВариантыФормДокументов.БумажнаяИлиЭлектронная;
		Иначе 
			ВидДокументаОбъект.ФормаДокумента = Перечисления.ВариантыФормДокументов.Бумажная;
		КонецЕсли;
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(ВидДокументаОбъект);
	КонецЦикла;
	
	// Добавление в настройки доступности по состоянию поля "ФормаДокумента" 
	СкопироватьНастройкиДоступностиПоСостояниюДляНовогоПоля("ФормаДокумента", "Организация");
	СкопироватьНастройкиДоступностиПоСостояниюДляНовогоПоля("ФормаДокумента", "Организация", "ВходящиеДокументы");
	СкопироватьНастройкиДоступностиПоСостояниюДляНовогоПоля("ФормаДокумента", "Организация", "ИсходящиеДокументы");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_22_1() Экспорт
	
	Для Каждого Пользователь Из ПользователиИнформационнойБазы.ПолучитьПользователей() Цикл
		
		СпособОткрытияИзображений = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить(
			"НастройкиОткрытияФайлов\СканыДокументов",
			"СпособОткрытия",,,
			Пользователь.Имя);
		
		Если Не ЗначениеЗаполнено(СпособОткрытияИзображений) Тогда
			Продолжить;
		КонецЕсли;
		
		РасширенияИзображений = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить(
			"НастройкиОткрытияФайлов\СканыДокументов",
			"Расширение",,,
			Пользователь.Имя);
		...
		Попытка
			...
			ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(
				...
				"СпособОткрытия",
				СпособОткрытияИзображений,,
				Пользователь.Имя);
			
			ОбщегоНазначения.ХранилищеОбщихНастроекСохранить(
				"НастройкиОткрытияФайлов\Изображения",
				"Расширение",
				РасширенияИзображений,,
				Пользователь.Имя);
...
Процедура ПерейтиНаВерсию_2_1_23_2() Экспорт
	
	ОбменСКонтрагентамиДО.ОбновитьПравилаУчетаВидовЭД();
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_23_3() Экспорт
	
	ОбменСКонтрагентамиДО.ЗаполнитьПравилаОтправкиДокументовЭДО();
	
КонецПроцедуры

Процедура ЗаполнитьФормуДокументовОтложенно(Параметры) Экспорт
	
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		
		ЗапросКоличество = Новый Запрос(
		"ВЫБРАТЬ
		|	КОЛИЧЕСТВО(НоменклатураДел.Ссылка) КАК Количество
		|ИЗ
		|	Справочник.НоменклатураДел КАК НоменклатураДел
		|ГДЕ
		|	НоменклатураДел.ФормаДокументов = ЗНАЧЕНИЕ(Перечисление.ВариантыФормДокументов.ПустаяСсылка)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		|	КОЛИЧЕСТВО(Документы.Ссылка)
		|ИЗ
		|	Справочник.ВнутренниеДокументы КАК Документы
		|ГДЕ
		|	Документы.ФормаДокумента = ЗНАЧЕНИЕ(Перечисление.ВариантыФормДокументов.ПустаяСсылка)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
	...
	Запрос = Новый Запрос(
		...
		|	ИСТИНА КАК ЭтоНД,
		|	НоменклатураДел.Год КАК ДатаГод
		|ИЗ
		|	Справочник.НоменклатураДел КАК НоменклатураДел
		|ГДЕ
		|	НоменклатураДел.ФормаДокументов = ЗНАЧЕНИЕ(Перечисление.ВариантыФормДокументов.ПустаяСсылка)
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			Если Выборка.ЭтоНД Тогда 
				Если ЗначениеЗаполнено(СпрОбъект.ФормаДокументов) Тогда 
					Продолжить;
				КонецЕсли;
				
				СпрОбъект.ФормаДокументов = Перечисления.ВариантыФормДокументов.Бумажная;
			Иначе 
				Если ЗначениеЗаполнено(СпрОбъект.ФормаДокумента) Тогда 
					Продолжить;
				КонецЕсли;
				
				СпрОбъект.ФормаДокумента = Перечисления.ВариантыФормДокументов.Бумажная;
			КонецЕсли;
	...
	Если Обработано = 0 И ПроблемныхЗаписей > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Процедуре ЗаполнитьФормуДокументовОтложенно не удалось обработать некоторые записи. Пропущено: %1'"),
			ПроблемныхЗаписей);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ПерейтиНаВерсию_2_1_23_5() Экспорт
	
	// обновляем РС СведенияОбАдресатах
	...
	Если Не РезультатЗапроса.Пустой() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Попытка
				НаборЗаписей = РегистрыСведений.СведенияОбАдресатах.СоздатьНаборЗаписей();
				НаборЗаписей.Отбор.АдресатСообщения.Установить(Выборка.АдресатСообщения);
				НаборЗаписей.Отбор.Контакт.Установить(Выборка.Контакт);
				
				Запись = НаборЗаписей.Добавить();
				ЗаполнитьЗначенияСвойств(Запись, Выборка);
				
				Запись.Представление = ВстроеннаяПочтаСервер.ПолучитьПочтовоеПредставлениеКонтакта(
					Запись.Контакт,
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'ОбновлениеРССведенияОбАдресатах'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
					УровеньЖурналаРегистрации.Ошибка,,,
					ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура ПерейтиНаВерсию_2_1_23_6() Экспорт
	
	// Восстановление подключения системы взаимодействия после сброса при добавлении разделителей. 
	Если Не ОбщегоНазначения.РазделениеВключено()
		И ОбщегоНазначения.ПрочитатьДанныеИзБезопасногоХранилища("ДанныеРегистрацииИнформационнойБазыСистемыВзаимодействия") <> Неопределено
		И СистемаВзаимодействия.ПолучитьДанныеРегистрацииИнформационнойБазы() = Неопределено
...
Процедура ПерейтиНаВерсию_2_1_23_7() Экспорт
	
	РаботаСФайламиВызовСервера.УстановитьГраницуОтключенияНачалаАвтораспознаванияВСервисе(500);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_23_8() Экспорт
	
	Если Не РаботаСФайламиВызовСервера.ПолучитьИспользоватьРаспознавание() Тогда
		Возврат;
	КонецЕсли;
	...
	Запрос.Текст =
		"ВЫБРАТЬ
		|	ПолучателиУведомленийОПроблемах.Получатель КАК Получатель,
		|	МАКСИМУМ(ПолучателиУведомленийОПроблемах.Раздел = ЗНАЧЕНИЕ(Перечисление.РазделыУведомленийОПроблемах.Распознавание)) КАК ПропуститьПолучателя
		|ИЗ
		|	РегистрСведений.ПолучателиУведомленийОПроблемах КАК ПолучателиУведомленийОПроблемах
		|
		|СГРУППИРОВАТЬ ПО
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ПропуститьПолучателя Тогда
			Продолжить;
		КонецЕсли;
		
		Запись = НаборЗаписей.Добавить();
		Запись.Получатель = Выборка.Получатель;
		Запись.Раздел = Перечисления.РазделыУведомленийОПроблемах.Распознавание;
	КонецЦикла;
...
Процедура ПерейтиНаВерсию_2_1_23_10() Экспорт
	
	// Реструктуризация разделителей.
	Политика = Константы.ПолитикаУчетаРабочегоВремени.Получить();
	Если Не ЗначениеЗаполнено(Политика) Тогда
		Возврат;
	КонецЕсли;
	
	КонстантаМенеджер = Константы.ИспользоватьЕжедневныеОтчеты.СоздатьМенеджерЗначения();
	КонстантаМенеджер.Значение = Политика <> Перечисления.ПолитикиУчетаРабочегоВремени.ИспользоватьЕженедельныеОтчеты;
	ОбновлениеИнформационнойБазы.ЗаписатьДанные(КонстантаМенеджер);
	
	КонстантаМенеджер = Константы.ИспользоватьЕженедельныеОтчеты.СоздатьМенеджерЗначения();
	КонстантаМенеджер.Значение = Политика <> Перечисления.ПолитикиУчетаРабочегоВремени.ИспользоватьЕжедневныеОтчеты;
	ОбновлениеИнформационнойБазы.ЗаписатьДанные(КонстантаМенеджер);
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_25_2() Экспорт
	
	// Заполнение реквизита ВариантУказанияОтменяющегоДокумента у видов внутренних документов
	...
	Запрос.Текст =
		...
		|	Справочник.ВидыВнутреннихДокументов КАК ВидыВнутреннихДокументов
		|ГДЕ
		|	ВидыВнутреннихДокументов.УчитыватьНедействующиеДокументы
		|	И ВидыВнутреннихДокументов.ВариантУказанияОтменяющегоДокумента =
		|		ЗНАЧЕНИЕ(Перечисление.ВариантыУказанияОтменяющегоДокумента.ПустаяСсылка)";
	
	Выборка = Запрос.Выполнить().Выбрать();
	
	Пока Выборка.Следующий() Цикл
		ВидДокументаОбъект = Выборка.ВидДокумента.ПолучитьОбъект();
		
		ВидДокументаОбъект.ВариантУказанияОтменяющегоДокумента =
			Перечисления.ВариантыУказанияОтменяющегоДокумента.Необязательное;
...
Процедура ПерейтиНаВерсию_2_1_25_4() Экспорт
	
	// Добавление роли БазовыеПраваИПП в профиль Пользователи.
	УправлениеДоступомДокументооборот.ДобавитьРольВПолномочия(
		Метаданные.Роли.БазовыеПраваИПП, "c999acb1-d5f5-11de-a544-00179ab398dc");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_26_1() Экспорт
	
	КалендарныеГрафики.СоздатьПроизводственныйКалендарьНа2021Год(Ложь, Истина);
	
КонецПроцедуры

Процедура ЗаполнениеГлавныхЗадачВПроцессахРешенияВопросовВыполненияЗадач(Параметры) Экспорт
	...
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		...
		Запрос.Текст = 
			"ВЫБРАТЬ
			|	КОЛИЧЕСТВО (РАЗЛИЧНЫЕ РешениеВопросовВыполненияЗадач.Ссылка) КАК КоличествоПроцессов
			|ИЗ
			|	БизнесПроцесс.РешениеВопросовВыполненияЗадач КАК РешениеВопросовВыполненияЗадач
			|ГДЕ
			|	РешениеВопросовВыполненияЗадач.ГлавнаяЗадача = ЗНАЧЕНИЕ(Задача.ЗадачаИсполнителя.ПустаяСсылка)";
		
		Выборка = Запрос.Выполнить().Выбрать();
		Выборка.Следующий();
		Параметры.ПрогрессВыполнения.ВсегоОбъектов = Выборка.КоличествоПроцессов;
	...
	Запрос.Текст = 
		...
		|
		|УПОРЯДОЧИТЬ ПО
		|	РешениеВопросовВыполненияЗадач.Дата УБЫВ";
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			ЗаблокироватьДанныеДляРедактирования(Выборка.Ссылка);
			ПроцессОбъект = Выборка.Ссылка.ПолучитьОбъект();
			ПроцессОбъект.ГлавнаяЗадача = ПроцессОбъект.ПредметРассмотрения;
			РаботаСБизнесПроцессами.ЗаписатьПроцесс(ПроцессОбъект, "ЗаписьСОбновлениемОбщегоСпискаПроцессов");
			
			РегистрыСведений.ДочерниеБизнесПроцессы.Удалить(Выборка.Ссылка);
			РегистрыСведений.ДочерниеБизнесПроцессы.Добавить(Выборка.Ссылка, ПроцессОбъект.ГлавнаяЗадача);
		...
		Исключение
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Не удалось обработать процесс решения вопросов %1 по причине:
					|%2'"),
				Выборка.Ссылка,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
			ЗаписьЖурналаРегистрации(
	...
	Если Обработано = 0 И ПроблемныхЗаписей > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'В процедуре ЗаполнениеГлавныхЗадачВПроцессахРешенияВопросовВыполненияЗадач не удалось обработать некоторые процессы (пропущены): %1'",
			ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
			ПроблемныхЗаписей);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ЗаполнитьГрифыУтверждения(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ЗаполнитьГрифыУтвержденияВоВнутреннихДокументах'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура ЗаполнениеТабличнойЧастиСтороныШаблоновВнутреннихДокументов(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ЗаполнитьСтороныВШаблонахВнутреннихДокументов'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура ЗаполнениеТабличнойЧастиСтороныВнутреннихДокументов(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ЗаполнитьСтороныВоВнутреннихДокументах'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура ЗаполнениеНаименованияСторон(Параметры) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ЗаполнитьНаименованийСторонВоВнутреннихДокументах'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
...
Процедура СкопироватьНастройкиДоступностиПоСостояниюДляНовогоПоля(ИмяПоля, ПолеКопирования, 
	ТипДокумента = "ВнутренниеДокументы")
		...
		Исключение
			ЗаписьЖурналаРегистрации(
				СтрШаблон(НСтр("ru = 'Ошибка добавления поля ""%1"" в настройки доступности по состоянию.'",
					ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), ИмяПоля),
				УровеньЖурналаРегистрации.Ошибка,,,
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
	КонецЦикла;
...
//
Процедура РеорганизацияРолейСОбъектамиАдресацииИсполнителиЗадач(Параметры = Неопределено) Экспорт
...
//
Процедура РеорганизацияРолейСОбъектамиАдресацииСоставСубъектовПравДоступа(Параметры = Неопределено) Экспорт
...
Процедура РеорганизацияРолейСОбъектамиАдресацииШаблоныДокументовИнструкции() Экспорт
	...
	РеорганизацияРолейСОбъектамиАдресацииПриНачалеОбработки(
		НСтр("ru = 'Шаблоны документов и инструкции'"),
		Статус);
...
Процедура РеорганизацияРолейСОбъектамиАдресацииНастройкиДоступностиЭскалация() Экспорт
	...
	РеорганизацияРолейСОбъектамиАдресацииПриНачалеОбработки(
		НСтр("ru = 'Настройки доступности и правила эскалации'"),
		Статус);
...
Процедура РеорганизацияРолейСОбъектамиАдресацииШаблоныПроцессовМонопольно() Экспорт
	...
	РеорганизацияРолейСОбъектамиАдресацииПриНачалеОбработки(
		НСтр("ru = 'Шаблоны процессов (монопольно)'"),
		Статус,
		Объектов);
...
Процедура РеорганизацияРолейСОбъектамиАдресацииШаблоныПроцессовОтложенно(Параметры) Экспорт
	...
	РеорганизацияРолейСОбъектамиАдресацииПриНачалеОбработки(
		НСтр("ru = 'Шаблоны процессов (отложенно)'"),
		Статус);
...
Процедура РеорганизацияРолейСОбъектамиАдресацииПроцессыИЗадачиМонопольно() Экспорт
	...
	РеорганизацияРолейСОбъектамиАдресацииПриНачалеОбработки(
		НСтр("ru = 'Процессы и задачи (монопольно)'"),
		Статус,
		Объектов);
...
Процедура РеорганизацияРолейСОбъектамиАдресацииПроцессыИЗадачиОтложенно(Параметры) Экспорт
	...
	РеорганизацияРолейСОбъектамиАдресацииПриНачалеОбработки(
		НСтр("ru = 'Процессы и задачи (отложенно)'"),
		Статус);
...
Процедура РеорганизацияРолейСОбъектамиАдресацииПриНачалеОбработки(ИмяОбработчика, Статус, Объектов = Неопределено)
	...
	Если Объектов = Неопределено Тогда
		ЗаписьЖурналаРегистрации(
			СтрШаблон(НСтр("ru = 'Реорганизация ролей. %1'"), ИмяОбработчика),
			УровеньЖурналаРегистрации.Информация,
			,
			,
			НСтр("ru = 'Обработка начата'"));
	Иначе
		ЗаписьЖурналаРегистрации(
			СтрШаблон(НСтр("ru = 'Реорганизация ролей. %1'"), ИмяОбработчика),
			УровеньЖурналаРегистрации.Информация,
			,
			,
			СтрШаблон(НСтр("ru = 'Обработка начата. Объектов: %1'"), Объектов));
	КонецЕсли;
		
	Статус = НСтр("ru = 'Выполняется'");
...
Процедура РеорганизацияРолейСОбъектамиАдресацииПриЗавершенииОбработки(ИмяОбработчика, ТекстЗапроса,
	...
	Иначе
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			СтрШаблон(НСтр("ru = 'Завершена обработка порции данных. Осталось объектов: %1'"), Объектов));
	КонецЕсли;
...
Процедура РеорганизацияРолейСОбъектамиАдресацииПриОшибкеОбработки(ИмяОбработчика, ТекстЗапроса,
	...
	Статус = НСтр("ru = 'Завершено с ошибками'");
...
Процедура РеорганизацияРолейСОбъектамиАдресацииШаблоныКомплексныхПроцессов() Экспорт
	...
	РеорганизацияРолейСОбъектамиАдресацииПриНачалеОбработки(
		НСтр("ru = 'Шаблоны комплексных процессов'"),
		Статус);
...
Функция СлужебнаяРабочаяГруппаДляЗаменыГруппыДоступа(ГруппаДоступа, МассивПользователей)
	...
	НаименованиеРодителя = НСтр("ru = 'Служебная (создана автоматически)'");
	НаименованиеГруппы = СтрШаблон(НСтр("ru = 'Пользователи группы доступа ""%1""'"),
...
Процедура НастроитьЧатБота()
	...
	Состояние = Справочники.СостоянияЧатБота.Стоп;
	КлючевыеСлова = НСтр("ru = 'Стоп
		|Хватит
		|Остановись'");
	Высказывание = НСтр("ru = 'Хорошо'");
	ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Действие");
	Действие = "ТекущееСостояниеЧатБота = ПредопределенноеЗначение(""Справочник.СостоянияЧатБота.ПустаяСсылка"");
		|ЗапрашиваемыеПараметрыСостоянияЧатБота = Неопределено;";
	Справочники.СостоянияЧатБота.ЗаполнитьСостояние(Состояние, ТипСостояния, Действие, КлючевыеСлова, Высказывание);
	
	Состояние = Справочники.СостоянияЧатБота.НеНайдено;
	КлючевыеСлова = "";
	Высказывание = НСтр("ru = 'Простите, ваш запрос мне непонятен'");
	Действие = ""; 
	ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Высказывание");
	Справочники.СостоянияЧатБота.ЗаполнитьСостояние(Состояние, ТипСостояния, Действие, КлючевыеСлова, Высказывание);
	
	Состояние = Справочники.СостоянияЧатБота.Уточнение;
	КлючевыеСлова = "";
	Высказывание = НСтр("ru = 'Вот что я могу'");
	Действие = "";
	ТипСостояния = ПредопределенноеЗначение("Перечисление.ТипыСостоянийЧатБота.Высказывание");
	Справочники.СостоянияЧатБота.ЗаполнитьСостояние(Состояние, ТипСостояния, Действие, КлючевыеСлова, Высказывание);
...
Процедура ОбновитьСпискиАвтоподстановокАдреснойКниги(Параметры = Неопределено) Экспорт
...
Процедура ПерейтиНаВерсию_2_1_22_3() Экспорт
	...
	Запрос.Текст = 
		...
		|	Справочник.ВидыВнутреннихДокументов КАК ВидыДокументов
		|ГДЕ
		|	(ВидыДокументов.УчитыватьМестоХранения = ЗНАЧЕНИЕ(Перечисление.ВариантыИспользованияПолейХранения.ПустаяСсылка)
		|			ИЛИ ВидыДокументов.УчитыватьОтветственногоЗаХранение = ЗНАЧЕНИЕ(Перечисление.ВариантыИспользованияПолейХранения.ПустаяСсылка))
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
	...
	Пока Выборка.Следующий() Цикл 
		ВидДокументаОбъект = Выборка.Ссылка.ПолучитьОбъект();
		ВидДокументаОбъект.УчитыватьМестоХранения = Перечисления.ВариантыИспользованияПолейХранения.НеУчитывать;
		ВидДокументаОбъект.УчитыватьОтветственногоЗаХранение = 
			Перечисления.ВариантыИспользованияПолейХранения.НеУчитывать;
		ОбновлениеИнформационнойБазы.ЗаписатьДанные(ВидДокументаОбъект);
	КонецЦикла;
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_22_5() Экспорт
	
	// Добавление в настройки доступности по состоянию поля "Место хранения" 
	СкопироватьНастройкиДоступностиПоСостояниюДляНовогоПоля("МестоХранения", "Дело");
	СкопироватьНастройкиДоступностиПоСостояниюДляНовогоПоля("МестоХранения", "Дело", "ВходящиеДокументы");
	СкопироватьНастройкиДоступностиПоСостояниюДляНовогоПоля("МестоХранения", "Дело", "ИсходящиеДокументы");
	
КонецПроцедуры

Процедура ПерейтиНаВерсию_2_1_22_6() Экспорт
	
	Если ПолучитьФункциональнуюОпцию("ИспользуетсяРаспознаваниеПриПомощиСервиса") Тогда
...
Процедура ЗаполнитьРСЗадачиСПодзадачами(Параметры) Экспорт
	
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		
		ЗапросКоличество = Новый Запрос(
		 "ВЫБРАТЬ
		 |	КОЛИЧЕСТВО(ДочерниеБизнесПроцессы.СвязующаяЗадача) КАК Количество
		 |ИЗ
		 ...
		 |		ПО (ЗадачиСПодзадачами.Задача = ДочерниеБизнесПроцессы.СвязующаяЗадача)
		 |ГДЕ
		 |	ДочерниеБизнесПроцессы.СвязующаяЗадача.Выполнена = ЛОЖЬ
		 |	И ЗадачиСПодзадачами.Задача ЕСТЬ NULL
		 |	И ДанныеБизнесПроцессов.Состояние = ЗНАЧЕНИЕ(Перечисление.СостоянияБизнесПроцессов.Активен)
		 |	И (ДочерниеБизнесПроцессы.СвязующаяЗадача.Исполнитель <> ЗНАЧЕНИЕ(Справочник.Пользователи.ПустаяССылка)
		 |			ИЛИ ДочерниеБизнесПроцессы.СвязующаяЗадача.РольИсполнителя <> ЗНАЧЕНИЕ(Справочник.ПолныеРоли.ПустаяССылка))"
		);
	...
	Запрос = Новый Запрос(
		"ВЫБРАТЬ ПЕРВЫЕ 2000
		 |	ДочерниеБизнесПроцессы.СвязующаяЗадача КАК Задача
		 |ИЗ
		 |	РегистрСведений.ДочерниеБизнесПроцессы КАК ДочерниеБизнесПроцессы
		 |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.ДанныеБизнесПроцессов КАК ДанныеБизнесПроцессов
		 |		ПО ДочерниеБизнесПроцессы.ДочернийПроцесс = ДанныеБизнесПроцессов.БизнесПроцесс
	...
	Пока Выборка.Следующий() Цикл
		...
		Попытка
			...
			НаборЗаписей = РегистрыСведений.ЗадачиСПодзадачами.СоздатьНаборЗаписей();	 
	...
	Если Обработано = 0 И ПроблемныхЗаписей > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Процедуре ЗаполнитьРСЗадачиСПодзадачами не удалось обработать некоторые записи (пропущены): %1'"),
			ПроблемныхЗаписей);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
...
Процедура ЗаполнитьПризнакНаличияОригиналовОтложенно(Параметры) Экспорт
	
	Если Параметры.ПрогрессВыполнения.ВсегоОбъектов = 0 Тогда
		
		ЗапросКоличество = Новый Запрос(
		"ВЫБРАТЬ
		|	КОЛИЧЕСТВО(ОбщиеРеквизитыДокументов.Документ) КАК Количество
		|ИЗ
		|	РегистрСведений.ОбщиеРеквизитыДокументов КАК ОбщиеРеквизитыДокументов
		|ГДЕ
		|	ОбщиеРеквизитыДокументов.СодержитОригинал
	...
	Запрос = Новый Запрос(
		...
		|	ОбщиеРеквизитыДокументов.Валюта КАК Валюта,
		|	ОбщиеРеквизитыДокументов.ДатаПолученияОригинала КАК ДатаПолученияОригинала,
		|	ОбщиеРеквизитыДокументов.ДатаРегистрации КАК ДатаРегистрации,
		|	ОбщиеРеквизитыДокументов.ДатаСортировки КАК ДатаСортировки,
		|	ОбщиеРеквизитыДокументов.Заголовок КАК Заголовок,
		|	ОбщиеРеквизитыДокументов.КонтрагентыДляСписков КАК КонтрагентыДляСписков,
		|	ОбщиеРеквизитыДокументов.ПоследнийЭтап КАК ПоследнийЭтап,
		|	ОбщиеРеквизитыДокументов.ПредставлениеСостояния КАК ПредставлениеСостояния,
		|	ОбщиеРеквизитыДокументов.ИсходящийНомерИДата КАК ИсходящийНомерИДата,
		|	ОбщиеРеквизитыДокументов.ОригиналПолучен КАК ОригиналПолучен,
		|	ОбщиеРеквизитыДокументов.ОригиналПолучил КАК ОригиналПолучил,
		|	ОбщиеРеквизитыДокументов.РегистрационныйНомер КАК РегистрационныйНомер,
		|	ОбщиеРеквизитыДокументов.РегистрационныйНомерИДата КАК РегистрационныйНомерИДата,
		|	ОбщиеРеквизитыДокументов.СодержитОригинал КАК СодержитОригинал,
		|	ОбщиеРеквизитыДокументов.СрокИсполнения КАК СрокИсполнения,
		|	ОбщиеРеквизитыДокументов.Сумма КАК Сумма
		|ПОМЕСТИТЬ ДокументыБезОтметки
		|ИЗ
		|	РегистрСведений.ОбщиеРеквизитыДокументов КАК ОбщиеРеквизитыДокументов
		|ГДЕ
		|	ОбщиеРеквизитыДокументов.СодержитОригинал
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ДокументыБезОтметки.Документ КАК Документ,
		|	Файлы.ДатаСоздания КАК ДатаСоздания,
		|	Файлы.Автор КАК Автор,
		|	ДокументыБезОтметки.Валюта КАК Валюта,
		|	ДокументыБезОтметки.ДатаПолученияОригинала КАК ДатаПолученияОригинала,
		|	ДокументыБезОтметки.ДатаРегистрации КАК ДатаРегистрации,
		|	ДокументыБезОтметки.ДатаСортировки КАК ДатаСортировки,
		|	ДокументыБезОтметки.Заголовок КАК Заголовок,
		|	ДокументыБезОтметки.КонтрагентыДляСписков КАК КонтрагентыДляСписков,
		|	ДокументыБезОтметки.ПоследнийЭтап КАК ПоследнийЭтап,
		|	ДокументыБезОтметки.ПредставлениеСостояния КАК ПредставлениеСостояния,
		|	ДокументыБезОтметки.ИсходящийНомерИДата КАК ИсходящийНомерИДата,
		|	ДокументыБезОтметки.ОригиналПолучен КАК ОригиналПолучен,
		|	ДокументыБезОтметки.ОригиналПолучил КАК ОригиналПолучил,
		|	ДокументыБезОтметки.РегистрационныйНомер КАК РегистрационныйНомер,
		|	ДокументыБезОтметки.РегистрационныйНомерИДата КАК РегистрационныйНомерИДата,
		|	ДокументыБезОтметки.СодержитОригинал КАК СодержитОригинал,
		|	ДокументыБезОтметки.СрокИсполнения КАК СрокИсполнения,
		|	ДокументыБезОтметки.Сумма КАК Сумма
		|ИЗ
		|	ДокументыБезОтметки КАК ДокументыБезОтметки
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.Файлы КАК Файлы
		|		ПО ДокументыБезОтметки.Документ = Файлы.ВладелецФайла
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрСведений.СведенияОФайлахДокументооборот КАК СведенияОФайлахДокументооборот
	...
	Выборка = Запрос.Выполнить().Выбрать();
	Пока Выборка.Следующий() Цикл
		Если ОбработанныеДокументы.Получить(Выборка.Документ) <> Неопределено Тогда 
			Продолжить;
		КонецЕсли;
		...
		Попытка
			...
			Блокировка = Новый БлокировкаДанных;
			ЭлементБлокировки = Блокировка.Добавить("РегистрСведений.ОбщиеРеквизитыДокументов");
			ЭлементБлокировки.Режим = РежимБлокировкиДанных.Исключительный;
			...
			Если НаборЗаписей.Количество() <> 0 Тогда 
				...
				Запись.ОригиналПолучил = Выборка.Автор;
				Запись.ДатаПолученияОригинала = Выборка.ДатаСоздания;
			Иначе 
				Запись = НаборЗаписей.Добавить();
				ЗаполнитьЗначенияСвойств(Запись, Выборка);
				Запись.ОригиналПолучен = Истина;
			...
			ОбновлениеИнформационнойБазы.ЗаписатьДанные(НаборЗаписей);
			ОбработанныеДокументы.Вставить(Выборка.Документ, Истина);
			ЗафиксироватьТранзакцию();
			Обработано = Обработано + 1;
	...
	Если Обработано = 0 И ПроблемныхЗаписей > 0 Тогда
		ТекстСообщения = СтрШаблон(
			НСтр("ru = 'Процедуре ЗаполнитьПризнакНаличияОригиналовОтложенно не удалось обработать некоторые записи (пропущены): %1'"),
			ПроблемныхЗаписей);
		ВызватьИсключение ТекстСообщения;
	КонецЕсли;
