	...
	Для Каждого Строка Из ТаблицаВерсий Цикл
		...
		Попытка
			...
			Если Строка.ФайлУдален Тогда
				...
				ИсключитьВерсиюСУдаленнымФайломИзОчередиАвтораспознавания(ВерсияСсылка, Параметры);
...
Процедура ИсключитьВерсиюСУдаленнымФайломИзОчередиАвтораспознавания(ВерсияСсылка, Параметры)
...
Процедура ДобавитьНаДискСУказаниемДлиныИмени(
