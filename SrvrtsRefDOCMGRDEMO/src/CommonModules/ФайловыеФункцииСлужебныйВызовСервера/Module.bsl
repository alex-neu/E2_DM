...
Процедура ПроверитьПодписи(ИсходныеДанные, ДанныеСтрок) Экспорт
	...
	Для каждого СтрокаПодписи Из ДанныеСтрок Цикл
		ОписаниеОшибки = "";
		РезультатПроверки = МодульЭлектроннаяПодпись.ПроверитьПодпись(МенеджерКриптографии,
		...
		СтрокаПодписи.ТекстОшибкиПроверкиПодписи = РезультатПроверки.ТекстОшибкиПроверкиПодписи;
		
		СтрокаПодписи.СертификатДействителен = РезультатПроверки.СертификатДействителен;
		СтрокаПодписи.ТекстОшибкиПроверкиСертификата = РезультатПроверки.ТекстОшибкиПроверкиСертификата;
