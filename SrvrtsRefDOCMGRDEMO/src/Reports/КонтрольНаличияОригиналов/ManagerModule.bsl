...
Процедура ЗаполнитьСписокКатегорийИРазделовОтчета(КлючВариантаОтчета, СписокКатегорий, СписокРазделов) Экспорт
	...
	Если КлючВариантаОтчета = "СписокДокументовБезОригиналов" Тогда
	...
	Если КлючВариантаОтчета = "СписокДокументовБезОригиналов" 
		Или КлючВариантаОтчета = "СтатистикаПоОригиналам" Тогда
	...
	Если КлючВариантаОтчета = "СтатистикаПоОригиналам" Тогда
