...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ДекорацияБыстрыйПоиск.Заголовок = 
		Новый ФорматированнаяСтрока(НСтр("ru = 'Быстрый поиск'"),,,,"Ссылка"); 
...
Процедура ЗаполнитьУсловноеОформлениеСпискаПисем(Список)
	...
	// Выделять непрочтенные письма цветом фона
	ЭлементУсловногоОформления = УсловноеОформлениеКД.Элементы.Добавить();
	ЭлементУсловногоОформления.Использование = Истина;
	
	ПредставлениеЭлемента = НСтр("ru = 'Выделять непрочтенные письма цветом фона (стандартная настройка)'");
	...
	// Выделять прочтенные письма цветом фона  - все поля
	ЭлементУсловногоОформления = УсловноеОформлениеКД.Элементы.Добавить();
	ЭлементУсловногоОформления.Использование = Истина;
	
	ПредставлениеЭлемента = НСтр("ru = 'Выделять прочтенные письма цветом фона (стандартная настройка)'");
	ЭлементУсловногоОформления.Представление = ПредставлениеЭлемента;
	...
	// Выделять прочтенные письма цветом текста - только поля Адресаты
	ЭлементУсловногоОформления = УсловноеОформлениеКД.Элементы.Добавить();
	ЭлементУсловногоОформления.Использование = Истина;
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("TextColor", 
		ЦветаСтиля.ЦветТекстаПрочтенныхПисемДвустрочногоСписка);
		
	Поле = ЭлементУсловногоОформления.Поля.Элементы.Добавить();
	Поле.Поле = Новый ПолеКомпоновкиДанных("Тема");
	...
	// Выделять прочтенные письма цветом текста - только поля Тема
	ЭлементУсловногоОформления = УсловноеОформлениеКД.Элементы.Добавить();
	ЭлементУсловногоОформления.Использование = Истина;
	...
	ПредставлениеЭлемента = НСтр("ru = 'Выделять адресатов писем с отсутствующими в контактах адресатами цветом (стандартная настройка)'");
	ЭлементУсловногоОформления.Представление = ПредставлениеЭлемента;
	...
	// Выделять помеченные на удаления сообщения зачеркнутым жирным шрифтом - Адресаты
	ЭлементУсловногоОформления = УсловноеОформлениеКД.Элементы.Добавить();
	ЭлементУсловногоОформления.Использование = Истина;
	...
	// Выделять помеченные на удаления сообщения зачеркнутым шрифтом - Тема
	ЭлементУсловногоОформления = УсловноеОформлениеКД.Элементы.Добавить();
	ЭлементУсловногоОформления.Использование = Истина;
	...
	ПредставлениеЭлемента = НСтр("ru = 'Выделять письма, отправка которых была отменена, цветом неактуальных записей (стандартная настройка)'");
	ЭлементУсловногоОформления.Представление = ПредставлениеЭлемента;
	...
	ПредставлениеЭлемента = НСтр("ru = 'Выделять письма с ошибкой отправки почты цветом (стандартная настройка)'");
	ЭлементУсловногоОформления.Представление = ПредставлениеЭлемента;
	...
	ПредставлениеЭлемента = НСтр("ru = 'Отображать дату писем за более ранний, чем эта неделя, период в виде ""10.06.2012"" (стандартная настройка)'");
	ЭлементУсловногоОформления.Представление = ПредставлениеЭлемента;
...
Процедура ЗагрузитьНастройки()
	...
	// эта форма - только для 2 строчного режима
	Если Не ДвустрочныйРежим Тогда
		
		ВариантОтображенияОбластиЧтения = Перечисления.ВариантыОтображенияОбластиЧтения.Справа;
		ВстроеннаяПочтаСервер.УстановитьПерсональнуюНастройку("ОтображениеОбластиЧтения", 
			ВариантОтображенияОбластиЧтения);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "ИзмененыНастройкиВстроеннойПочты"
		...
		Если Параметр.Свойство("ОтображениеОбластиЧтения")
			...
			РанееБылДвустрочныйРежим = Истина; // мы в форме с 2 строчным режимом
			ДвустрочныйРежим = (Параметр.ОтображениеОбластиЧтения = ОбластьСправа);
...
Процедура ОтозватьПисьмо(Команда)
	...
	Если Не ВстроеннаяПочтаКлиентСервер.ЭтоИсходящееПисьмо(ВыбранноеПисьмо) Тогда 
		ПоказатьПредупреждение(, НСтр("ru = 'Можно отозвать только отправленное исходящее письмо.'"));
		Возврат;
	КонецЕсли;
...
Процедура ПометитьКакПрочтенные(Команда)
	...
	ПометитьКакПрочтенныеПисьма(Письма);
	
КонецПроцедуры	

&НаКлиенте
Процедура ПометитьКакПрочтенныеПисьма(Письма)
...
Процедура ОтображатьУдаленныеСервер(ЗаполнятьДеревоПапок = Ложь)
	...
	Элементы.ОтображатьУдаленныеПисьмаИПапки_ВсеДействия.Пометка = ОтображатьУдаленныеПисьмаИПапки;
...
Процедура ПапкиПередНачаломИзменения(Элемент, Отказ)
	...
	Если Элемент.ТекущиеДанные <> Неопределено Тогда
		...
		Иначе	
			ПоказатьПредупреждение(, НСтр("ru = 'Нельзя изменить предопределенную папку ""Папки поиска"".'"));
		КонецЕсли;
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ИначеЕсли Элемент.ТекущийЭлемент = Элементы.Прочтено Тогда
		
		СтандартнаяОбработка = Ложь;
		Письма = Новый Массив;
		Письма.Добавить(ВыбранноеПисьмо);
		ПометитьКакПрочтенныеПисьма(Письма);
...
Процедура ПереместитьВПапкуКлиент(Письма, Папка)
	...
	Если НеПеренесеноПисем > 0 Тогда
		...
		Если НеПеренесеноПисем = 1 Тогда
			ТемаПисьма = ОбщегоНазначенияДокументооборотВызовСервера.ЗначениеРеквизитаОбъекта(
				НеПеренесенныеПисьма[0].Письмо, "Тема");
			СообщениеОбОшибке = "";
...
Процедура ОбновитьДанные(СведенияОПапках = Неопределено)
	...
	Если ТипЗнч(ТекущаяПапка) = Тип("СправочникСсылка.ПапкиПоиска") И ЗначениеЗаполнено(ТекущаяПапка) Тогда
...
Процедура ОбновитьСвойстваПапок(СведенияОПапках)
	...
	Если Не ПоказыватьДеревоПапок Тогда    
		...
		ЭтаФорма.Заголовок = НСтр("ru = 'Почта:'") + " " + ТекущаяПапкаОписание;
...
Процедура ОтборВПапкеЗначениеСтрокаПриИзменении(Элемент)
	...
	Если ТекущиеДанные.Параметр = "Текст" Тогда
		...
		Если СловаПисьма.Количество() > 1 Тогда
			Слово = СловаПисьма[0];
			ТекстСообщения = НСтр("ru ='В быстром поиске по тексту писем можно использовать только одно слово.'");
...
Процедура ОбновитьСписокВыбораУТекущегоПоляОтбора(ДанныеВыбора = Неопределено)
	...
	Если Элементы.ОтборВПапке.ТекущаяСтрока <> Неопределено Тогда
		...
		Таблица = ЭтаФорма.Элементы.ОтборВПапке;
		...
		Элементы.ОтборВПапкеЗначение.КнопкаВыбора = 
			...
			Или Найти("Адресаты, Дата_По, Дата_С, Флаг", Таблица.ТекущиеДанные.Параметр) > 0;
			
		Если Таблица.ТекущиеДанные.Параметр = "Прочтено" Тогда
			Элементы.ОтборВПапкеЗначение.КнопкаВыбора = Ложь;
		КонецЕсли;	
...
Процедура ОтборВПапкеПриАктивизацииСтроки(Элемент)
	...
	Если ТекущаяСтрокаВОтбореВПапке <> Элементы.ОтборВПапке.ТекущаяСтрока Тогда
		...
		Таблица = ЭтаФорма.Элементы.ОтборВПапке;
		Элементы.ОтборВПапкеЗначение.КнопкаВыбора = Найти("Адресаты, Дата_По, Дата_С, Флаг", Таблица.ТекущиеДанные.Параметр) > 0;
		...
		Элементы.ОтборВПапкеЗначение.КнопкаВыпадающегоСписка = Найти("Флаг, Прочтено", Таблица.ТекущиеДанные.Параметр) > 0;
...
Процедура ОтборВПапкеЗначениеОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	Если ТипЗнч(ВыбранноеЗначение) = Тип("Массив") Тогда
		Если ВыбранноеЗначение.Количество() = 1 Тогда
			Строка = ВыбранноеЗначение[0];
			Элементы.ОтборВПапке.ТекущиеДанные.Значение = Строка.Контакт;
		КонецЕсли;
	Иначе
...
Процедура ПометитьПапкуНаУдаление(Команда)
	...
	Если Ссылка = Неопределено Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Нельзя удалить предопределенную папку ""Папки поиска"".'"));
		Возврат;
	КонецЕсли;
...
Процедура ОтборВПапкеЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ТекущиеДанные = ЭтаФорма.Элементы.ОтборВПапке.ТекущиеДанные;
	
	Если ТекущиеДанные = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	Если ТекущиеДанные.Параметр = "Адресаты" Тогда
		СтандартнаяОбработка = Ложь;
		ПараметрыОткрытия = Новый Структура;
		...
		ПараметрыОткрытия.Вставить("ВыбиратьРабочиеГруппы", Истина);
		ПараметрыОткрытия.Вставить("ВыбиратьПодразделения", Истина);
		ПараметрыОткрытия.Вставить("ВыбиратьГруппыКонтактов", Истина);
		ПараметрыОткрытия.Вставить("Заголовок", ТекущиеДанные.ПредставлениеПараметра);
		
		М = Новый Массив;
		Если ТипЗнч(ТекущиеДанные.Значение) = Тип("СписокЗначений") Тогда
			Для Каждого Эл Из ТекущиеДанные.Значение Цикл
				Если Не (ТипЗнч(Эл.Значение) = Тип("Строка")) Тогда
					М.Добавить(РаботаСАдреснойКнигойКлиент.СтруктураВыбранногоАдресата(Эл.Значение));
				КонецЕсли;
			КонецЦикла;
		ИначеЕсли ЗначениеЗаполнено(ТекущиеДанные.Значение) Тогда
			Если Не (ТипЗнч(ТекущиеДанные.Значение) = Тип("Строка")) Тогда
				М.Добавить(РаботаСАдреснойКнигойКлиент.СтруктураВыбранногоАдресата(ТекущиеДанные.Значение));
			КонецЕсли;
		КонецЕсли;
		ПараметрыОткрытия.Вставить("ВыбранныеАдресаты", М);
		
		ОписаниеОповещения = Новый ОписаниеОповещения(
			"ВыбратьАдресатаПродолжение",
			ЭтотОбъект);
		
		РаботаСАдреснойКнигойКлиент.ВыбратьАдресатов(ПараметрыОткрытия, Элемент, ОписаниеОповещения);
	...
	ИначеЕсли ТипЗнч(ТекущиеДанные.Значение) = Тип("Булево") Тогда
		ТекущиеДанные.Значение = Строка(ТекущиеДанные.Значение);
...
&НаКлиенте
Процедура ВыбратьАдресатаПродолжение(Результат, Параметры) Экспорт
	...
	Если Результат.Количество() = 1 Тогда
		...
		ТекущиеДанные.Значение = Строка.Контакт;
...
Функция СформироватьЗаголовок(ПолныйПутьПапки, КоличествоПисем)
	...
	ЗаголовокФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Почта: %1'"), ПолныйПутьПапки);
...
//Возвращает представление отбора в виде форматированной строки
//
// Параметры
//  ОтборВПапке - список значений с отборами
//  МелкийШрифт - Шрифт - мелкий шрифт специально для представления отбора
//
//  Возвращаемое значение - ФорматированнаяСтрока - представление отбора
&НаКлиентеНаСервереБезКонтекста
...
Процедура СкопироватьСтрокиНаСервере(ЧислоФайлов)
	...
	ОбщегоНазначенияДокументооборот.СкопироватьФайлыВБуферОбменаИзТаблицыФайлы(Вложения, Элементы.Вложения.ВыделенныеСтроки);
...
Процедура Отправить(Команда)
	...
	Если ОтправляемыеПисьма.Количество() = 0 Тогда 
		ПоказатьПредупреждение(,НСтр("ru = 'Команда может быть выполнена только для неотправленных исходящих писем'"));
		Возврат;
	КонецЕсли;	
...
Процедура ПометитьВсеПисьмаВПапкеКакПрочтенные(Команда)
	...
	Если ПоказыватьДеревоПапок Тогда 
		...
		Иначе
			ПоказатьПредупреждение(, НСтр("ru = 'Не выбрана папка.'"));
			Возврат;
		КонецЕсли;
	Иначе 
	...
	Иначе 
		Если Не ЭтоФайловаяБаза Тогда
			...
			ПараметрыФормы.Вставить("ЗаголовокФормы", 
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Все письма папки ""%1"" помечаются как прочтенные'"),
					ПапкаПрочтения));
		...
		Иначе
			...
			Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Все письма папки ""%1"" помечаются как прочтенные. Пожалуйста, подождите...'"),
				ПапкаПрочтения);
			Состояние(Текст);
			...
			ПоказатьПредупреждение(,
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Пометка о прочтении всех писем папки ""%1"" установлена.'"), 
...
Процедура ПометитьВсеПисьмаВПапкеНаУдаление(Команда)
	...
	Иначе 
		Если Не ЭтоФайловаяБаза Тогда
			...
			ПараметрыФормы.Вставить("ЗаголовокФормы", 
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Все письма папки ""%1"" помечаются на удаление'"),
					ПапкаПрочтения));
		...
		Иначе
			...
			Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Все письма папки ""%1"" помечаются на удаление. Пожалуйста, подождите...'"),
				ПапкаПрочтения);
			Состояние(Текст);
			...
			ПоказатьПредупреждение(,
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Все письма папки ""%1"" помечены на удаление.'"), 
					Строка(ПапкаПрочтения)));
		КонецЕсли;
...
Процедура ПереместитьВсеПисьмаВКорзину(Команда)
	...
	Иначе 
		Если Не ЭтоФайловаяБаза Тогда
			...
			ПараметрыФормы.Вставить("ЗаголовокФормы", 
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Все письма папки ""%1"" переносятся в корзину'"),
					ПапкаИсточник));
		...
		Иначе
			...
			Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Все письма папки ""%1"" переносятся в корзину. Пожалуйста, подождите...'"),
				ПапкаИсточник);
			Состояние(Текст);
			...
			ОбновитьДанные();
			Состояние();
			ПоказатьПредупреждение(, НСтр("ru = 'Все письма перенесены в корзину.'"));
		КонецЕсли;
...
Процедура ПеренестиВсеПисьмаВПапкуЗавершение(ПапкаПриемник, ДополнительныеПараметры) Экспорт
	...
	Иначе 
		Если Не ЭтоФайловаяБаза Тогда
			...
			ПараметрыФормы.Вставить("ЗаголовокФормы", 
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Все письма папки ""%1"" переносятся в папку ""%2""'"),
		...
		Иначе
			...
			Текст = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Все письма папки ""%1"" переносятся в папку ""%2"". Пожалуйста, подождите...'"),
				ПапкаИсточник, ПапкаПриемник);
			Состояние(Текст);
			...
			ПоказатьПредупреждение(,
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Все письма перенесены в папку ""%1"".'"), 
