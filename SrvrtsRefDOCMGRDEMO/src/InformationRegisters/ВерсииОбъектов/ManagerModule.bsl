...
Функция УдалитьПорциюУстаревшихДанных() Экспорт
	...
	ГраницыУдаленияОбъектов = ВерсионированиеОбъектов.ГраницыУдаленияОбъектов();
	...
	Для Индекс = 0 По ГраницыУдаленияОбъектов.Количество() - 1 Цикл
		...
		КонецЕсли;
		Условие = "(" + Условие + ")";
		ДополнительныеУсловия = ДополнительныеУсловия + СтрШаблон(
			"
			|	%1
	...
	ЗаписьЖурналаРегистрации(
		...
		Метаданные.РегистрыСведений.ВерсииОбъектов,, 
