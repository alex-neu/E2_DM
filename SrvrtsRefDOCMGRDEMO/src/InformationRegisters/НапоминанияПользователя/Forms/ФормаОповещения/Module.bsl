...
Процедура Прекратить(Команда)
	...
	ПрекращаемыеНапоминания = Новый Массив;
	Для Каждого ИндексСтроки Из Элементы.Напоминания.ВыделенныеСтроки Цикл
		...
		ПрекращаемоеНапоминание = НапоминанияПользователяКлиентСервер.ОписаниеНапоминания(ДанныеСтроки, Истина);
		ПрекращаемыеНапоминания.Добавить(ПрекращаемоеНапоминание);
	КонецЦикла;
...
Процедура ОтложитьАктивныеНапоминания()
	...
	Для Каждого СтрокаТаблицы Из Напоминания Цикл
		...
		ПараметрыНапоминания = НапоминанияПользователяКлиентСервер.ОписаниеНапоминания(СтрокаТаблицы, Истина);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Запись_НапоминанияПользователя_Документооборот"
		Или ИмяСобытия = "Удаление_НапоминанияПользователя_Документооборот" Тогда
		ОбновитьТаблицуНапоминаний();
	КонецЕсли;
	Если ИмяСобытия = "ЗакрытьФормуНапоминания" И Открыта() Тогда
