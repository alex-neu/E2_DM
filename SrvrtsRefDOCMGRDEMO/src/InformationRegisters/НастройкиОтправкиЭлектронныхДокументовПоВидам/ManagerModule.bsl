...
Процедура УдалитьНастройкиОтправкиЭДО(Параметры, АдресРезультата) Экспорт
	...
	НаборЗаписейДО = РегистрыСведений.НастройкиОтправкиДокументовПоЭДО.СоздатьНаборЗаписей();
	НаборЗаписейДО.Отбор.Отправитель.Установить(Организация);
	НаборЗаписейДО.Отбор.Получатель.Установить(Контрагент);
