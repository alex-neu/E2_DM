...
Функция ПредставленияКолонок(ИмяТаблицы) 
	...
	Если ИмяТаблицы = "ПапкиВнутреннихДокументов" Тогда
		...
		Стр.Заголовок = НСтр("ru = 'Документы'");
		Стр.Подсказка = НСтр("ru = 'Права на документы'");
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ТаблицаПравПравоЧтенияСтрокой";
		Стр.Подсказка = НСтр("ru = 'Чтение папок и документов'");
		
	ИначеЕсли ИмяТаблицы = "ПапкиФайлов" Тогда
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ПраваСодержимого";
		Стр.Заголовок = НСтр("ru = 'Файлы'");
		Стр.Подсказка = НСтр("ru = 'Права на файлы'");
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ТаблицаПравПравоЧтенияСтрокой";
		Стр.Подсказка = НСтр("ru = 'Чтение папок и файлов'");
		
	ИначеЕсли ИмяТаблицы = "ПапкиМероприятий" Тогда
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ПраваСодержимого";
		Стр.Заголовок = НСтр("ru = 'Мероприятия'");
		Стр.Подсказка = НСтр("ru = 'Права на мероприятия'");
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ТаблицаПравПравоЧтенияСтрокой";
		Стр.Подсказка = НСтр("ru = 'Чтение папок и мероприятий'");
		
	ИначеЕсли ИмяТаблицы = "ПапкиПисем" Тогда
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ПраваСодержимого";
		Стр.Заголовок = НСтр("ru = 'Письма'");
		Стр.Подсказка = НСтр("ru = 'Права на письма'");
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ТаблицаПравПравоЧтенияСтрокой";
		Стр.Подсказка = НСтр("ru = 'Чтение папок и писем'");
		
	ИначеЕсли ИмяТаблицы = "ПапкиПроектов" Тогда
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ПраваСодержимого";
		Стр.Заголовок = НСтр("ru = 'Проекты'");
		Стр.Подсказка = НСтр("ru = 'Права на проекты'");
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ТаблицаПравПравоЧтенияСтрокой";
		Стр.Подсказка = НСтр("ru = 'Чтение папок и проектов'");
		
	ИначеЕсли ИмяТаблицы = "ПапкиФорума" Тогда
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ПраваСодержимого";
		Стр.Заголовок = НСтр("ru = 'Темы и сообщения'");
		Стр.Подсказка = НСтр("ru = 'Права на темы и сообщения'");
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ТаблицаПравПравоЧтенияСтрокой";
		Стр.Подсказка = НСтр("ru = 'Чтение папок, тем и сообщений'");
		...
		Стр.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'Изм. %1 разделов'"), Символы.ПС);
		Стр.Подсказка = НСтр("ru = 'Изменение разделов'");
		
		Стр = Представления.Добавить();
		Стр.ИмяЭлемента = "ТаблицаПравПередаватьДочернимСтрокой";
		Стр.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("ru = 'Для %1 подразделов'"), Символы.ПС);
		Стр.Подсказка = НСтр("ru = 'Передавать настройку дочерним разделам при наследовании'");
...
Процедура ПодборПользователей(Команда)
	...
	ПараметрыФормы.Вставить("ЗаголовокФормы", НСтр("ru = 'Подбор пользователей, подразделений, групп'"));
