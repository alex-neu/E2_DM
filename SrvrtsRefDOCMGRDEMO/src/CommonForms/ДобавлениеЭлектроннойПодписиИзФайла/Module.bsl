...
Процедура ВыбратьФайлПослеВыгрузкиСертификата(ДанныеСертификата, Контекст) Экспорт
	...
	//Обозначим, что подпись загружена из файла
	СвойстваПодписи.Вставить("ПодписьЗагруженаИзФайла", Истина);
	
	//Добавим доп поля для раздельной проверки подписи и сертификата
...
Процедура ВыбратьФайлПослеПроверкиПодписи(Результат, Контекст) Экспорт
	...
	ОбновитьРезультатПроверкиПодписи(Контекст.АдресСвойствПодписи, Результат);
	
КонецПроцедуры

&НаСервере
Процедура ОбновитьРезультатПроверкиПодписи(АдресСвойствПодписи, Результат)
	...
	Если ТипЗнч(Результат) = Тип("Булево") Тогда
		СвойстваПодписи.ПодписьВерна = Результат;
		СвойстваПодписи.СертификатДействителен = Результат;
	Иначе
		СвойстваПодписи.ПодписьВерна = Не Результат.Свойство("ТекстОшибкиПроверкиПодписи");
		СвойстваПодписи.СертификатДействителен = Не Результат.Свойство("ТекстОшибкиПроверкиСертификата");
	КонецЕсли;
