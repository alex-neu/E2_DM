...
Процедура ОтправитьОбъекты(Команда)
	...
	Если ЗначениеЗаполнено(Пользователи) И Не ЗначениеЗаполнено(ОбъектыКОтправке) Тогда
		ПомощникОтправитьКлиент.ОтправитьПользователям(Пользователи, ЭтаФорма);
		Возврат;
	КонецЕсли;
