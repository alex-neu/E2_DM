...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Отключение полей для мобильного клиента
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.ДатаНачала.АвтоМаксимальнаяШирина = Ложь;
	Элементы.ДатаНачала.МаксимальнаяШирина = 8;
	Элементы.ДатаНачала.РастягиватьПоГоризонтали = Ложь;
	Элементы.ДатаНачала.Вид = ВидПоляФормы.ПолеНадписи;
	...
	// Закладка Работы.
	Элементы.Работы.Подвал = Ложь;
	Элементы.КнопкаПодбор.Видимость = Ложь;
	Элементы.Итого.Ширина = 0;
	Элементы.Итого.АвтоМаксимальнаяШирина = Ложь;
	Элементы.Итого.МаксимальнаяШирина = 4;
	Элементы.Работа.МногострочныйРежим = Истина;
	
	// Закладка Дни недели.
	Элементы.ДеньНеделиДата.Группировка = ГруппировкаКолонок.Вертикальная;
	Элементы.НачалоОкончаниеДня.Группировка = ГруппировкаКолонок.Вертикальная;
	Элементы.НачалоОкончаниеДня.ОтображатьВШапке = Истина;
	Элементы.НачалоОкончаниеДня.ОтображатьЗаголовок = Истина;
	Элементы.ДеньНедели.АвтоМаксимальнаяШирина = Ложь;
	Элементы.ДеньНедели.МаксимальнаяШирина = 8;
	Элементы.ДатаДня.АвтоМаксимальнаяШирина = Ложь;
	Элементы.ДатаДня.МаксимальнаяШирина = 8;
	Элементы.ВидДня.АвтоМаксимальнаяШирина = Ложь;
	Элементы.ВидДня.МаксимальнаяШирина = 6;
	Элементы.НачалоДня.АвтоМаксимальнаяШирина = Ложь;
	Элементы.НачалоДня.МаксимальнаяШирина = 8;
	Элементы.НачалоДня.ОтображатьВШапке = Ложь;
	Элементы.ОкончаниеДня.АвтоМаксимальнаяШирина = Ложь;
	Элементы.ОкончаниеДня.МаксимальнаяШирина = 8;
	Элементы.ОкончаниеДня.ОтображатьВШапке = Ложь;
