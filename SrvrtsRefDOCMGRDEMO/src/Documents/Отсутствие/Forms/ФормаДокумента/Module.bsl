...
#Если МобильныйКлиент Тогда
	Если Объект.ВесьДень Тогда
		...
		Элементы.ДатаОкончания.ФорматРедактирования = "ДЛФ=D";
	Иначе
		Элементы.ДатаНачала.ФорматРедактирования = "ДЛФ=DT";
		Элементы.ДатаОкончания.ФорматРедактирования = "ДЛФ=DT";
	КонецЕсли;
#КонецЕсли
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	// Командная панель.
	Элементы.ФормаЗаписатьИЗакрыть.Отображение = ОтображениеКнопки.Авто;
	
	// установим вертикальную группировку у групп в шапке.
	...
	Элементы.ГруппаВидОтсутствия.ВыравниваниеЭлементовИЗаголовков = ВариантВыравниванияЭлементовИЗаголовков.ЭлементыПравоЗаголовкиЛево;
	
	// Подготовим область ввода даты отсутствия.
	Если Объект.ВесьДень Тогда
		Элементы.ДатаНачала.ФорматРедактирования = "ДЛФ=D";
		Элементы.ДатаОкончания.ФорматРедактирования = "ДЛФ=D";
	Иначе
	...
	Элементы.ДатаНачалаВремя.Видимость = Ложь;
	Элементы.ДекорацияРазделительВремени.Видимость = Ложь;
	Элементы.ДатаОкончанияВремя.Видимость = Ложь;
	...
	// Подготовим ТЧ Заместители.
	Элементы.ГруппаЗаместителиЗаголовок.Видимость = Истина;
	Элементы.ДобавитьЗаместителяМК.Видимость = Не ТолькоПросмотр;
	Элементы.ЗаместителиНомерСтроки.Видимость = Истина;
...
&НаКлиенте
Процедура ДобавитьЗаместителяМК(Команда)
