...
Процедура Обновить(Команда)
	...
	ОбновитьОтображениеКлиент(Истина, Истина, Истина);
...
Процедура ОбновитьОтображение(ЗаполнитьСпискиВыбора = Ложь, ЗапомнитьТерритории = Ложь, ЗаполнитьДеревоТерриторий = Ложь)
	...
	ПараметрыБрони.ВремяНачала = РаботаСЧасовымиПоясами.ПривестиКВремениСеанса(ВремяНачала);
	ПараметрыБрони.ВремяОкончания = РаботаСЧасовымиПоясами.ПривестиКВремениСеанса(ВремяОкончания);
