		...
		Для Инд1 = 0 По Работы.Количество()-2 Цикл
			...
			Для Инд2 = Инд1+1 По Работы.Количество()-1 Цикл
				...
				Если (Строка2.Начало >= Строка1.Начало 
					...
					И Строка2.НачалоЗаполночь = Строка2.НачалоЗаполночь)
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.ПериодРабочегоДня.ВыравниваниеЭлементовИЗаголовков =
	...
	Элементы.Пользователь.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Лево;
