...
Процедура РедактироватьЗавершить()
	...
	Если (ДанныеФайла.ФайлРедактируется И НЕ ДанныеФайла.РедактируетТекущийПользователь)
...
Процедура ОткрытьФайлВложения()
	...
	ФайлРедактируется = ДанныеФайла.ФайлРедактируется И ДанныеФайла.РедактируетТекущийПользователь;
	...
	Если НаправлениеИсходящий 
		...
		Если ЕстьВложения Тогда
			...
			Если ДанныеФайла.ФайлРедактируется Тогда
				...
				Элементы.ТекстРедактируетФайл.ЦветТекста = ЦветаСтиля[?(ДанныеФайла.РедактируетТекущийПользователь,
			...
			Если МожноРедактироватьПередаваемыеПараметры И НЕ ДанныеФайла.ПодписанЭП Тогда
				...
				Элементы.Освободить.Доступность = ДанныеФайла.ФайлРедактируется И ДанныеФайла.РедактируетТекущийПользователь;
			Иначе
...
Процедура ОсвободитьФайлНаСервере(ДанныеФайла)
	...
	Если ДанныеФайла.Ссылка = Неопределено Тогда
		...
		ДанныеФайла.РедактируетТекущийПользователь     = Ложь;
	Иначе
