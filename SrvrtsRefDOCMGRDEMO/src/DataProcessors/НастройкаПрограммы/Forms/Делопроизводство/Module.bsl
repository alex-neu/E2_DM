...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ГруппаРегламентированнуюОтчетность.Доступность = НаборКонстант.ВестиУчетОбращенийГраждан;
	Элементы.КлассификаторОбращенийГраждан.Доступность = НаборКонстант.РегламентированныйУчетОбращений;
	Элементы.ДатаПроверкиНаличияВопросов.Доступность = НаборКонстант.РегламентированныйУчетОбращений;
	
	Элементы.ОбязательныйУчетДелПоМестамХранения.Доступность = НаборКонстант.ИспользоватьНоменклатуруДел;
...
&НаКлиенте
Процедура ИспользоватьНоменклатуруДелПриИзменении(Элемент)
	
	Если Не НаборКонстант.ИспользоватьНоменклатуруДел Тогда 
		НаборКонстант.ОбязательныйУчетДелПоМестамХранения = Ложь;
	КонецЕсли;
...
Процедура ИспользоватьРегламентированнуюОтчетностьПриИзменении(Элемент)
	...
	ИначеЕсли НаборКонстант.РегламентированныйУчетОбращений Тогда 
		НаборКонстант.ДатаПроверкиНаличияВопросов = ТекущаяДата();
	КонецЕсли;
