...
Функция РезультатЗапросаСертификатов(ИдентификаторЭДО = Неопределено) Экспорт
	...
	|	ЕСТЬNULL(Сертификаты.Сертификат, НЕОПРЕДЕЛЕНО) КАК Сертификат
	|ИЗ
	|	РегистрСведений.УчетныеЗаписиЭДО КАК УчетныеЗаписи
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СертификатыУчетныхЗаписейЭДО КАК Сертификаты
	|		ПО УчетныеЗаписи.ИдентификаторЭДО = Сертификаты.ИдентификаторЭДО
	...
	|ГДЕ
	|	ВЫБОР
	|			КОГДА &ИдентификаторЭДО = НЕОПРЕДЕЛЕНО
	|				ТОГДА ИСТИНА
	|			ИНАЧЕ УчетныеЗаписи.ИдентификаторЭДО = &ИдентификаторЭДО
	|		КОНЕЦ
	|ИТОГИ ПО
	|	ИдентификаторЭДО";
