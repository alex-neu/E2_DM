...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// html
	СтрокаНастройки = НастройкиОткрытияФайлов.Добавить();
	СтрокаНастройки.ТипФайла = Перечисления.ТипыФайловДляВстроенногоРедактора.HtmlФайлы;
	...
	СтрокаНастройки = НастройкиОткрытияФайлов.Добавить();
	СтрокаНастройки.ТипФайла = Перечисления.ТипыФайловДляВстроенногоРедактора.Изображения;
	...
	Элементы.НастройкаРаспознавания.Видимость = 
		РаботаСФайламиВызовСервера.ПолучитьИспользоватьРаспознавание()
		И РаботаСФайламиВызовСервера.ДоступноРаспознаваниеПоЗапросу()
		И РаботаСФайламиВызовСервера.КоличествоЯзыковРаспознавания(
			РаботаСФайламиВызовСервера.ПрограммаРаспознавания()) > 1;
...
Процедура СохранитьНастройки()
	...
	Если НастройкиОткрытияФайлов.Количество() >= 2 Тогда 
		ДобавитьСтруктуруНастройки(МассивСтруктур, "НастройкиОткрытияФайлов\HtmlФайлы", "Расширение", 
			НастройкиОткрытияФайлов[1].Расширение);
		ДобавитьСтруктуруНастройки(МассивСтруктур, "НастройкиОткрытияФайлов\HtmlФайлы", "СпособОткрытия", 
			НастройкиОткрытияФайлов[1].СпособОткрытия);
	КонецЕсли;
	
	Если НастройкиОткрытияФайлов.Количество() >= 3 Тогда 
		ДобавитьСтруктуруНастройки(МассивСтруктур, "НастройкиОткрытияФайлов\Изображения", "Расширение", 
			НастройкиОткрытияФайлов[2].Расширение);
		ДобавитьСтруктуруНастройки(МассивСтруктур, "НастройкиОткрытияФайлов\Изображения", "СпособОткрытия", 
			НастройкиОткрытияФайлов[2].СпособОткрытия);
	КонецЕсли;
