...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РежимОтображенияМестногоВремени = РаботаСЧасовымиПоясами.РежимОтображенияМестногоВремениПерсональный();
...
Процедура СохранитьНастройки()
	...
	// Форма ЗадачиМне
	ДобавитьСтруктуруНастройки(МассивСтруктур, "Задачи", "ВидФормыЗадачиМне", ВидФормыЗадачиМне);
