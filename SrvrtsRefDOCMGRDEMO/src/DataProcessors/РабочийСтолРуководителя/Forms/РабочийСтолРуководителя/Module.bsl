...
Процедура ОбновитьПоля()
	...
	Элементы.ДекорацияЗадачиОтМеня.Заголовок = НСтр("ru='Мои процессы'") + " (" + Формат(ЧислоЗадачОтМеня, "ЧН=0") + ")";
...
Процедура ОткрытьРассмотрение()
	...
	ОткрытьФормуЗадачиМне("Рассмотрение");
...
Процедура ОткрытьСогласование()
	...
	ОткрытьФормуЗадачиМне("Согласование");
...
Процедура ОткрытьУтверждение()
	...
	ОткрытьФормуЗадачиМне("Утверждение");
...
Процедура ВсеЗадачи()
	...
	ОткрытьФормуЗадачиМне(Неопределено);
	
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьФормуЗадачиМне(ИмяБизнесПроцесса)
	
	ПараметрыФормы =
		Новый Структура("ИмяБизнесПроцесса, ОткрытаИзФормыРабочийСтолРуководителя", ИмяБизнесПроцесса, Истина);
		
#Если МобильныйКлиент Тогда
	ИмяФормыЗадачиМне = "Задача.ЗадачаИсполнителя.Форма.МК_ЗадачиМне";
#Иначе
	ИмяФормыЗадачиМне = "Задача.ЗадачаИсполнителя.Форма.ЗадачиМнеБезГруппировкиПоПредметам";
#КонецЕсли
	
	ОткрытьФорму(ИмяФормыЗадачиМне, ПараметрыФормы, , ИмяБизнесПроцесса);
...
Процедура НастроитьЭлементыФормыДляМобильногоУстройства()
	...
	Элементы.ГруппаКомандыЗапускаПроцессов.РастягиватьПоГоризонтали = Истина;
	Элементы.ГруппаКомандыОбновить.РастягиватьПоГоризонтали = Истина;
	Элементы.ГруппаКомандыОбновить.ГоризонтальноеПоложениеПодчиненных = ГоризонтальноеПоложениеЭлемента.Право;
	
	Элементы.ДекорацияВсеЗадачи.ВертикальноеПоложение = ВертикальноеПоложениеЭлемента.Центр;
	Элементы.ДекорацияНаРассмотрение.ВертикальноеПоложение = ВертикальноеПоложениеЭлемента.Центр;
	Элементы.ДекорацияСогласование.ВертикальноеПоложение = ВертикальноеПоложениеЭлемента.Центр;
	Элементы.ДекорацияУтверждение.ВертикальноеПоложение = ВертикальноеПоложениеЭлемента.Центр;
	Элементы.ДекорацияЗадачиОтМеня.ВертикальноеПоложение = ВертикальноеПоложениеЭлемента.Центр;
	Элементы.ДекорацияЗадачиОтМеняПросроченные.ВертикальноеПоложение = ВертикальноеПоложениеЭлемента.Центр;
